...
/* FUN_0017cf70 (0x17cf70) — XBE naked draft (batch 399). */
#if defined(__clang__)
...
void FUN_0017cf70(void)
{
  __asm__ volatile(
      ...
      "movl %%esp, %%ebp\n\t"
      "popl %%ebp\n\t"
      ".byte 0xe9, 0x97, 0x22, 0xfe, 0xff\n\t"
      :
      :
      : "memory");
}
#else
#error "FUN_0017cf70: clang naked draft required"
#endif
...
/* FUN_0017cf90 (0x17cf90) — XBE naked draft (batch 399). */
#if defined(__clang__)
...
void FUN_0017cf90(void)
{
  __asm__ volatile(
      ...
      "movl %%esp, %%ebp\n\t"
      "popl %%ebp\n\t"
      ".byte 0xe9, 0x87, 0x22, 0xfe, 0xff\n\t"
      :
      :
      : "memory");
}
#else
#error "FUN_0017cf90: clang naked draft required"
#endif
...
/* FUN_0017cff0 (0x17cff0) — XBE naked draft (batch 400). */
#if defined(__clang__)
...
void FUN_0017cff0(void)
{
  __asm__ volatile(
      ...
      "movl %%esp, %%ebp\n\t"
      "popl %%ebp\n\t"
      ".byte 0xe9, 0x87, 0xe5, 0xff, 0xff\n\t"
      :
      :
      : "memory");
}
#else
#error "FUN_0017cff0: clang naked draft required"
#endif
...
#else
#error "FUN_0017d9d0: clang naked draft required"
#endif
...
/* FUN_0017dec0 (0x17dec0) — XBE naked draft (batch 383). */
#if defined(__clang__)


__attribute__((naked, noinline))
void FUN_0017dec0(int a0 __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
...
#else
#error "FUN_0017dec0: clang naked draft required"
#endif
...
/* FUN_0017e010 (0x17e010) — XBE naked draft (batch 368). */
#if defined(__clang__)
...
#else
#error "FUN_0017e010: clang naked draft required"
#endif
...
/* FUN_0017ed70 (0x17ed70) — XBE naked draft (batch 378). */
#if defined(__clang__)
...
#else
#error "FUN_0017ed70: clang naked draft required"
#endif
