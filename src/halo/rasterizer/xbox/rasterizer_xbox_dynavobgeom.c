...
/* FUN_0015e770 (0x15e770) — XBE naked draft (batch 359). */
#if defined(__clang__)
static void (*const b15e770_c1ef100)(void) = (void *)D3DVertexBuffer_Lock;
...
void FUN_0015e770(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1ef100] "m"(b15e770_c1ef100)
      : "memory");
}
#else
#error "FUN_0015e770: clang naked draft required"
#endif
...
#if defined(__clang__)
static void (*const b15f220_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b15f220_exitfn)(int) = system_exit;
...
void FUN_0015f220(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [assert] "m"(b15f220_assert), [exitfn] "m"(b15f220_exitfn)
      : "memory");
}
#else
#error "FUN_0015f220: clang naked draft required"
#endif


/* FUN_0015f540 (0x15f540) — XBE naked draft (batch 386). */
#if defined(__clang__)
static void (*const b15f540_assert)(const char *, const char *, int, bool) = display_assert;
...
void FUN_0015f540(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [assert] "m"(b15f540_assert), [exitfn] "m"(b15f540_exitfn)
      : "memory");
}
#else
#error "FUN_0015f540: clang naked draft required"
#endif


/* FUN_0015f5e0 (0x15f5e0) — XBE naked draft (batch 381). */
#if defined(__clang__)
static void __stdcall (*const b15f5e0_c1ed280)(uint32_t reg, float a, float b) = (void *)D3DDevice_SetVertexData2f;
...
void FUN_0015f5e0(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1ed280] "m"(b15f5e0_c1ed280)
      : "memory");
}
#else
#error "FUN_0015f5e0: clang naked draft required"
#endif
...
#if defined(__clang__)
static void (*const b160950_c158ae0)(int mode) = (void *)FUN_00158ae0;
static void (*const b160950_c16fa40)(int16_t profile) = (void *)FUN_0016fa40;
...
void FUN_00160950(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c158ae0] "m"(b160950_c158ae0), [c16fa40] "m"(b160950_c16fa40)
      : "memory");
}
#else
#error "FUN_00160950: clang naked draft required"
#endif
...
#if defined(__clang__)
static void (*const b1609b0_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b1609b0_exitfn)(int) = system_exit;
static void * (*const b1609b0_c1906b0)(void *shader, int shader_type) = FUN_001906b0;
static void (*const b1609b0_c178b40)(int a1, int a2, int a3) = FUN_00178b40;
static void (*const b1609b0_c190a90)(void) = shader_environment_texture_animation_evaluate;
static void __stdcall (*const b1609b0_c1eb8d0)(int register_index, const void *data, uint32_t count) = (void *)D3DDevice_SetVertexShaderConstant;
static uint32_t (*const b1609b0_c159070)(float a1) = FUN_00159070;
static void (*const b1609b0_c1e9350)(uint32_t reg, uint32_t value) = D3DDevice_SetRenderState_Simple;
static void (*const b1609b0_c15de60)(void) = FUN_0015de60;
static void (*const b1609b0_c17edd0)(void) = rasterizer_frame_statistics_count_static_vertices;
...
void FUN_001609b0(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [assert] "m"(b1609b0_assert), [exitfn] "m"(b1609b0_exitfn), [c1906b0] "m"(b1609b0_c1906b0), [c178b40] "m"(b1609b0_c178b40), [c190a90] "m"(b1609b0_c190a90), [c1eb8d0] "m"(b1609b0_c1eb8d0), [c159070] "m"(b1609b0_c159070), [c1e9350] "m"(b1609b0_c1e9350), [c15de60] "m"(b1609b0_c15de60), [c17edd0] "m"(b1609b0_c17edd0)
      : "memory");
}
#else
#error "FUN_001609b0: clang naked draft required"
#endif
...
#if defined(__clang__)
static void (*const b160c10_c16f910)(int16_t profile) = (void *)FUN_0016f910;
...
void FUN_00160c10(void)
{
  __asm__ volatile(
      ...
      "call *%[c16f910]\n\t"
      "addl $4, %%esp\n\t"
      ".byte 0xe9, 0xc1, 0x40, 0x01, 0x00\n\t"
      :
      : [c16f910] "m"(b160c10_c16f910)
      : "memory");
}
#else
#error "FUN_00160c10: clang naked draft required"
#endif
...
/* FUN_00164590 (0x164590) — XBE naked draft (batch 334). */
#if defined(__clang__)
static void (*const b164590_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b164590_exitfn)(int) = system_exit;
static void (*const b164590_c155c20)(int stage, void *bitmap_data) = rasterizer_set_texture_bitmap_data;
static void __stdcall (*const b164590_c1e9410)(uint32_t stage, uint32_t state, uint32_t value) = (void *)D3DDevice_SetTextureStageState;
...
void FUN_00164590(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [assert] "m"(b164590_assert), [exitfn] "m"(b164590_exitfn), [c155c20] "m"(b164590_c155c20), [c1e9410] "m"(b164590_c1e9410)
      : "memory");
}
#else
#error "FUN_00164590: clang naked draft required"
#endif
...
/* FUN_00165980 (0x165980) — XBE naked draft (batch 381). */
#if defined(__clang__)
static void __stdcall (*const b165980_c1ea650)(uint32_t count, void *rects, uint32_t flags, uint32_t color, float z, uint32_t stencil) = (void *)D3DDevice_Clear;
...
void FUN_00165980(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1ea650] "m"(b165980_c1ea650)
      : "memory");
}
#else
#error "FUN_00165980: clang naked draft required"
#endif
...
#if defined(__clang__)
static void (*const b165de0_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b165de0_exitfn)(int) = system_exit;
...
void FUN_00165de0(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [assert] "m"(b165de0_assert), [exitfn] "m"(b165de0_exitfn)
      : "memory");
}
#else
#error "FUN_00165de0: clang naked draft required"
#endif
...
/* FUN_00168230 (0x168230) — XBE naked draft (batch 388). */
#if defined(__clang__)
static void __stdcall (*const b168230_c1e6ae0)(uint32_t width, uint32_t height, uint32_t levels, uint32_t usage, uint32_t format, uint32_t pool, void *out_texture) = (void *)D3DDevice_CreateTexture;
...
void FUN_00168230(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1e6ae0] "m"(b168230_c1e6ae0)
      : "memory");
}
#else
#error "FUN_00168230: clang naked draft required"
#endif
...
void FUN_00168250(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1e6b10] "m"(b168250_c1e6b10)
      : "memory");
}
#else
#error "FUN_00168250: clang naked draft required"
#endif


/* FUN_00168280 (0x168280) — XBE naked draft (batch 380). */
#if defined(__clang__)
static void (*const b168280_c1e6b40)(void) = (void *)D3DDevice_CreateCubeTexture;
...
void FUN_00168280(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1e6b40] "m"(b168280_c1e6b40)
      : "memory");
}
#else
#error "FUN_00168280: clang naked draft required"
#endif


/* FUN_001682c0 (0x1682c0) — XBE naked draft (batch 385). */
#if defined(__clang__)
static void __stdcall (*const b1682c0_c1edc70)(void *texture, unsigned int level, void *locked_rect, void *rect, unsigned int flags) = (void *)D3DTexture_LockRect;
...
void FUN_001682c0(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1edc70] "m"(b1682c0_c1edc70)
      : "memory");
}
#else
#error "FUN_001682c0: clang naked draft required"
#endif


/* FUN_00168300 (0x168300) — XBE naked draft (batch 359). */
#if defined(__clang__)
static void (*const b168300_c1edd80)(void) = (void *)D3DVolumeTexture_LockBox;
...
void FUN_00168300(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1edd80] "m"(b168300_c1edd80)
      : "memory");
}
#else
#error "FUN_00168300: clang naked draft required"
#endif
...
/* FUN_00168bc0 (0x168bc0) — XBE naked draft (batch 389). */
#if defined(__clang__)
static int __stdcall (*const b168bc0_c1ef0a0)(uint32_t length, uint32_t usage, uint32_t fvf, uint32_t pool, void **ppVertexBuffer) = (void *)D3DDevice_CreateVertexBuffer;
...
void FUN_00168bc0(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1ef0a0] "m"(b168bc0_c1ef0a0)
      : "memory");
}
#else
#error "FUN_00168bc0: clang naked draft required"
#endif
...
#if defined(__clang__)
static void (*const b168c40_c1ef100)(void) = (void *)D3DVertexBuffer_Lock;
...
void FUN_00168c40(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1ef100] "m"(b168c40_c1ef100)
      : "memory");
}
#else
#error "FUN_00168c40: clang naked draft required"
#endif
...
/* FUN_00169650 (0x169650) — XBE naked draft (batch 388). */
#if defined(__clang__)
static void __stdcall (*const b169650_c1ed280)(uint32_t reg, float a, float b) = (void *)D3DDevice_SetVertexData2f;
...
void FUN_00169650(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1ed280] "m"(b169650_c1ed280)
      : "memory");
}
#else
#error "FUN_00169650: clang naked draft required"
#endif
