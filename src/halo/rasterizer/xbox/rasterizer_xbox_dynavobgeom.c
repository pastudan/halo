...
/* FUN_0015f630 (0x15f630) — readable C lift (restored pre-naked). */
...
/* FUN_001621c0 (0x1621c0) — readable C lift (restored pre-naked). */
...
/* FUN_00162920 (0x162920) — readable C lift (restored pre-naked). */
...
/* FUN_00163590 (0x163590) — readable C lift (restored pre-naked). */
...
/* FUN_00163910 (0x163910) — readable C lift (restored pre-naked). */
...
/* FUN_00166890 (0x166890) — readable C lift (restored pre-naked). */
...
/* FUN_001686c0 (0x1686c0) — readable C lift (restored pre-naked). */
void FUN_001686c0(void)
{
  ...
  ((void(*)(void))D3DVolumeTexture_LockBox)();
...
/* FUN_001688d0 (0x1688d0) — readable C lift (restored pre-naked). */
void FUN_001688d0(void)
{
  ...
  ((void(*)(void))D3DCubeTexture_LockRect)();
...
/* FUN_0016bed0 (0x16bed0) — readable C lift (restored pre-naked). */
...
/* FUN_0016c090 (0x16c090) — readable C lift (restored pre-naked). */
void FUN_0016c090(void)
{
  ...
  system_exit(0);
  ((void(*)(void))shader_type_is_valid_for_model)();
