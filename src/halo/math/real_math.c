...
/* 0x113a90 */
int FUN_00113a90(int codes, int *z, int r)
{
  int eax = 0;
  int ecx = 0;
  int edx = 0;
  ...
  FUN_00116280(0, 0, 0);
  /* cmp edi, 3 -> jae 0x113b57 */
  /* test ecx, ecx -> je 0x11438d */
  /* test ecx, ecx -> jle 0x113ba5 */
  crt_fprintf((void *)0x00331070, (char *)0x0028d62c);
  /* test eax, eax -> jle 0x113bf2 */
  crt_fprintf((void *)0x00331070, (char *)0x0028d608);
  FUN_00116250((void *)(uintptr_t)eax, (void *)(uintptr_t)edx, (void *)(uintptr_t)ecx, (void *)(uintptr_t)eax);
  FUN_001146e0(0, 0, 0, 0, 0);
  /* test ecx, ecx -> jle 0x113c6f */
  crt_fprintf((void *)0x00331070, (char *)0x0028d5e4);
  /* cmp edi, 0x20 -> jae 0x113cc3 */
  /* test ecx, ecx -> je 0x11438d */
  /* cmp edx, ecx -> jne 0x1143e2 */
  crt_fprintf((void *)0x00331070, (char *)0x0028d5c0);
  /* test ecx, ecx -> je 0x113d19 */
  /* test eax, eax -> je 0x11438d */
  /* test edx, edx -> jne 0x113dcd */
  /* relift: cmp dword ptr [ebp + 8], edx -> jne 0x113d64 */
  /* cmp ecx, eax -> je 0x113d64 */
  FUN_00116280(0, 0, 0);
  /* cmp eax, ecx -> je 0x113dc5 */
  /* test edx, edx -> je 0x1143f6 */
  /* cmp eax, ecx -> jbe 0x113df0 */
  csmemcpy((void *)(uintptr_t)edx, (void *)(uintptr_t)ecx, eax);
  /* test eax, eax -> jle 0x113e70 */
  /* cmp edx, ecx -> jb 0x113e4e */
  crt_fprintf((void *)0x00331070, (char *)0x0028d594);
  /* cmp edi, 0xe -> jae 0x113ec3 */
  return 0;
