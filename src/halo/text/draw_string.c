...
#if defined(__clang__)
static short (*const b19b910_c7c840)(short format) = bitmap_format_bits_per_pixel;
static void (*const b19b910_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b19b910_exitfn)(int) = system_exit;
...
void bitmap_draw_character(void)
{
  __asm__ volatile(
      ...
      "orl %%edx, %%edi\n\t"
      "movl %%edi, -0x4(%%ebp)\n\t"
      "jmp .Lbitmap_draw_character_2\n\t"
      ".Lbitmap_draw_character_1:\n\t"
      "movl -0x4(%%ebp), %%edi\n\t"
      ".Lbitmap_draw_character_2:\n\t"
      "movw 0x2c(%%ebp), %%cx\n\t"
      "testw %%cx, %%cx\n\t"
      "jle .Lbitmap_draw_character_21\n\t"
      "movswl %%ax, %%edx\n\t"
      "movzwl %%cx, %%eax\n\t"
      "pushl %%ebx\n\t"
      "movl %%edx, -0x18(%%ebp)\n\t"
      ...
      "testw %%ax, %%ax\n\t"
      "movl %%ebx, 0x2c(%%ebp)\n\t"
      "jl .Lbitmap_draw_character_4\n\t"
      "movl 0x4d9ae8, %%ecx\n\t"
      "cmpw 0x6(%%ecx), %%ax\n\t"
      "jle .Lbitmap_draw_character_5\n\t"
      ".Lbitmap_draw_character_4:\n\t"
      "pushl $1\n\t"
      "pushl $0x1e6\n\t"
      "pushl $0x2b4210\n\t"
      "pushl $0x2b443c\n\t"
      ...
      "movw 0x18(%%ebp), %%dx\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lbitmap_draw_character_5:\n\t"
      "testw %%dx, %%dx\n\t"
      "jl .Lbitmap_draw_character_6\n\t"
      "movw 0x28(%%ebp), %%ax\n\t"
      "movswl %%ax, %%ecx\n\t"
      "movl %%ecx, -0xc(%%ebp)\n\t"
      "movswl %%dx, %%ecx\n\t"
      ...
      "movswl 0x4(%%ecx), %%ecx\n\t"
      "cmpl %%ecx, %%edx\n\t"
      "jle .Lbitmap_draw_character_7\n\t"
      ".Lbitmap_draw_character_6:\n\t"
      "pushl $1\n\t"
      "pushl $0x1e7\n\t"
      "pushl $0x2b4210\n\t"
      "pushl $0x2b43fc\n\t"
      ...
      "movw 0x28(%%ebp), %%ax\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lbitmap_draw_character_7:\n\t"
      "movl -0x18(%%ebp), %%ecx\n\t"
      "cmpl $0xb, %%ecx\n\t"
      "ja .Lbitmap_draw_character_19\n\t"
      "movzbl 0x19bcb4(%%ecx), %%edx\n\t"
      "jmp *.Lbitmap_draw_character_jt(,%%edx,4)\n\t"
      ".Lbitmap_draw_character_8:\n\t"
      "testw %%ax, %%ax\n\t"
      "jle .Lbitmap_draw_character_20\n\t"
      "movzwl %%ax, %%eax\n\t"
      "movl %%eax, 0x2c(%%ebp)\n\t"
      "nop\n\t"
      ".Lbitmap_draw_character_9:\n\t"
      "movzbw (%%ebx), %%ax\n\t"
      "testw %%ax, %%ax\n\t"
      "je .Lbitmap_draw_character_11\n\t"
      "movswl 0xc(%%ebp), %%edx\n\t"
      "movb (%%esi), %%cl\n\t"
      "movswl %%ax, %%eax\n\t"
      "imull %%edx, %%eax\n\t"
      ...
      "movswl %%ax, %%eax\n\t"
      "cmpl %%ecx, %%eax\n\t"
      "jle .Lbitmap_draw_character_10\n\t"
      "movl %%ecx, %%eax\n\t"
      ".Lbitmap_draw_character_10:\n\t"
      "movb %%al, (%%esi)\n\t"
      ".Lbitmap_draw_character_11:\n\t"
      "movl 0x2c(%%ebp), %%eax\n\t"
      "incl %%ebx\n\t"
      "incl %%esi\n\t"
      "decl %%eax\n\t"
      "movl %%eax, 0x2c(%%ebp)\n\t"
      "jne .Lbitmap_draw_character_9\n\t"
      "jmp .Lbitmap_draw_character_20\n\t"
      ".Lbitmap_draw_character_12:\n\t"
      "testw %%ax, %%ax\n\t"
      "jle .Lbitmap_draw_character_20\n\t"
      "movzwl %%ax, %%eax\n\t"
      "movl %%eax, -0x8(%%ebp)\n\t"
      ".Lbitmap_draw_character_13:\n\t"
      "movb (%%ebx), %%al\n\t"
      "testb %%al, %%al\n\t"
      "je .Lbitmap_draw_character_14\n\t"
      "movswl 0xc(%%ebp), %%ecx\n\t"
      "movw (%%esi), %%dx\n\t"
      "movzbl %%al, %%eax\n\t"
      "imull %%ecx, %%eax\n\t"
      ...
      "movl %%ebx, 0x2c(%%ebp)\n\t"
      "movl %%eax, -0x8(%%ebp)\n\t"
      "jne .Lbitmap_draw_character_13\n\t"
      "jmp .Lbitmap_draw_character_20\n\t"
      ".Lbitmap_draw_character_15:\n\t"
      "testw %%ax, %%ax\n\t"
      "jle .Lbitmap_draw_character_20\n\t"
      "movzwl %%ax, %%edx\n\t"
      "movl %%edx, -0xc(%%ebp)\n\t"
      "leal (%%esp), %%esp\n\t"
      ".Lbitmap_draw_character_16:\n\t"
      "movzbw (%%ebx), %%cx\n\t"
      "testw %%cx, %%cx\n\t"
      "je .Lbitmap_draw_character_18\n\t"
      "movswl 0xc(%%ebp), %%edx\n\t"
      "movl (%%esi), %%eax\n\t"
      "movswl %%cx, %%ecx\n\t"
      "imull %%edx, %%ecx\n\t"
      ...
      "movl %%eax, -0x1c(%%ebp)\n\t"
      "movl %%edx, -0x8(%%ebp)\n\t"
      "ja .Lbitmap_draw_character_17\n\t"
      "movl %%ebx, -0x8(%%ebp)\n\t"
      ".Lbitmap_draw_character_17:\n\t"
      "movzbl 0x16(%%ebp), %%ebx\n\t"
      "movswl %%di, %%ecx\n\t"
      "imull %%edx, %%ebx\n\t"
      "movzbl -0x1a(%%ebp), %%edi\n\t"
      ...
      "movl %%ebx, 0x2c(%%ebp)\n\t"
      "movl %%eax, -0xc(%%ebp)\n\t"
      "jne .Lbitmap_draw_character_16\n\t"
      "jmp .Lbitmap_draw_character_20\n\t"
      ".Lbitmap_draw_character_19:\n\t"
      "pushl $1\n\t"
      "pushl $0x22c\n\t"
      "pushl $0x2b4210\n\t"
      "pushl $0x261888\n\t"
      ...
      "movl %%ecx, 0x1c(%%ebp)\n\t"
      "movl %%eax, -0x10(%%ebp)\n\t"
      "jne .Lbitmap_draw_character_3\n\t"
      "popl %%esi\n\t"
      "popl %%ebx\n\t"
      ".Lbitmap_draw_character_21:\n\t"
      "popl %%edi\n\t"
      "movl %%ebp, %%esp\n\t"
      "popl %%ebp\n\t"
      "ret\n\t"
      "leal (%%ecx), %%ecx\n\t"
      ".section .rdata,\"dr\"\n\t"
      ".Lbitmap_draw_character_jt:\n\t"
      ".long .Lbitmap_draw_character_8\n\t"
      ".long .Lbitmap_draw_character_12\n\t"
      ".long .Lbitmap_draw_character_15\n\t"
      ".long .Lbitmap_draw_character_19\n\t"
      ".text\n\t"
      :
      : [c7c840] "m"(b19b910_c7c840), [assert] "m"(b19b910_assert), [exitfn] "m"(b19b910_exitfn)
      : "memory");
}
#else
#error "bitmap_draw_character: clang naked draft required"
#endif
...
static void (*const b19be30_c19d380)(void) = FUN_0019d380;
...
/* FUN_0019c1b0 (0x19c1b0) — XBE naked draft (batch 244). */
#if defined(__clang__)
static void (*const b19c1b0_c19bd30)(void) = FUN_0019bd30;
static void (*const b19c1b0_c19be30)(void) = parse_string;
static void * (*const b19c1b0_c19cff0)(void *font_tag, unsigned short character) = FUN_0019cff0;
...
void FUN_0019c1b0(void)
{
  __asm__ volatile(
      ...
      "jl .LFUN_0019c1b0_10\n\t"
      "cmpw 0x4d9b4c, %%ax\n\t"
      "jge .LFUN_0019c1b0_10\n\t"
      "movl 0x14(%%ebp), %%eax\n\t"
      "xorl $0xffffff, %%eax\n\t"
      "jmp .LFUN_0019c1b0_11\n\t"
      ".LFUN_0019c1b0_10:\n\t"
      "movl 0x14(%%ebp), %%eax\n\t"
      ".LFUN_0019c1b0_11:\n\t"
      "leal -0x38(%%ebp), %%ecx\n\t"
      ...
      "movswl -0x4(%%ebp), %%ebx\n\t"
      "cmpl %%ebx, %%edi\n\t"
      "jle .LFUN_0019c1b0_12\n\t"
      "movl -0x4(%%ebp), %%esi\n\t"
      "subl %%ecx, %%esi\n\t"
      ".LFUN_0019c1b0_12:\n\t"
      "movl -0x10(%%ebp), %%ebx\n\t"
      "cmpw %%bx, %%cx\n\t"
      "jge .LFUN_0019c1b0_13\n\t"
      "movl %%ebx, %%edi\n\t"
      "subl %%ecx, %%edi\n\t"
      "movl %%edi, -0x14(%%ebp)\n\t"
      "movl %%ebx, %%ecx\n\t"
      ...
      "movswl -0x8(%%ebp), %%ebx\n\t"
      "cmpl %%ebx, %%edi\n\t"
      "jle .LFUN_0019c1b0_14\n\t"
      "movl -0x8(%%ebp), %%edi\n\t"
      "subl %%edx, %%edi\n\t"
      "jmp .LFUN_0019c1b0_15\n\t"
      ".LFUN_0019c1b0_14:\n\t"
      "movl 0x10(%%ebp), %%edi\n\t"
      ".LFUN_0019c1b0_15:\n\t"
      "movl -0xc(%%ebp), %%ebx\n\t"
      "cmpw %%bx, %%dx\n\t"
      "jge .LFUN_0019c1b0_16\n\t"
      "subl %%edx, %%ebx\n\t"
      "movl -0xc(%%ebp), %%edx\n\t"
      "subl %%ebx, %%edi\n\t"
      "jmp .LFUN_0019c1b0_17\n\t"
      ".LFUN_0019c1b0_16:\n\t"
      "movl -0x1c(%%ebp), %%ebx\n\t"
      ".LFUN_0019c1b0_17:\n\t"
      "testw %%si, %%si\n\t"
      "jle .LFUN_0019c1b0_18\n\t"
      "testw %%di, %%di\n\t"
      "jle .LFUN_0019c1b0_18\n\t"
      "pushl %%edi\n\t"
      "pushl %%esi\n\t"
      ...
      "ret\n\t"
      :
      : [c19bd30] "m"(b19c1b0_c19bd30), [c19be30] "m"(b19c1b0_c19be30), [c19cff0] "m"(b19c1b0_c19cff0)
      : "memory");
}
#else
#error "FUN_0019c1b0: clang naked draft required"
#endif
