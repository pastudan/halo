...
#if defined(__clang__)
static void (*const d36bc0_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const d36bc0_exitfn)(int) = system_exit;
static bool (*const d36bc0_gerun)(void) = game_engine_running;
static float (*const d36bc0_g5590)(short) = FUN_000b5590;
static float (*const d36bc0_g55b0)(short, int) = FUN_000b55b0;
static float (*const d36bc0_ma710)(short, float) = transition_function_evaluate;
static void (*const d36bc0_d69e0)(int, int) = FUN_001369e0;
static void (*const d36bc0_d6b40)(int) = FUN_00136b40;
static void *(*const d36bc0_get)(int, int) = object_get_and_verify_type;
static void (*const d36bc0_ftol)(void) = FUN_001d9068;

__attribute__((naked, noinline))
void FUN_00136bc0(int current_object_handle __attribute__((unused)), void *collision_model __attribute__((unused)), void *material __attribute__((unused)), void *damage_effect __attribute__((unused)), void *damage_params __attribute__((unused)), unsigned int *flags __attribute__((unused)), float *shield_damage __attribute__((unused)), float *body_damage __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "fstp %%st(0)\n\t"
      "testb $8, %%ah\n\t"
      "jne .LFUN_00136bc0_14\n\t"
      "flds 0x94(%%esi)\n\t"
      "fsubs 0x8(%%ebp)\n\t"
      "fstps 0x94(%%esi)\n\t"
      ".LFUN_00136bc0_14:\n\t"
      "testb $2, %%al\n\t"
      "jne .LFUN_00136bc0_18\n\t"
      "flds 0x94(%%esi)\n\t"
      "fcomps 0x184(%%ebx)\n\t"
      "fnstsw %%ax\n\t"
      "testb $5, %%ah\n\t"
      ...
      "fnstsw %%ax\n\t"
      "testb $0x41, %%ah\n\t"
      "jne .LFUN_00136bc0_16\n\t"
      "fadds -0xc(%%ebp)\n\t"
      "fstps -0xc(%%ebp)\n\t"
      "jmp .LFUN_00136bc0_17\n\t"
      ".LFUN_00136bc0_16:\n\t"
      "fstp %%st(0)\n\t"
      ".LFUN_00136bc0_17:\n\t"
      "testb $8, 0xb6(%%esi)\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(d36bc0_assert), [exitfn] "m"(d36bc0_exitfn), [gerun] "m"(d36bc0_gerun), [g5590] "m"(d36bc0_g5590), [g55b0] "m"(d36bc0_g55b0), [ma710] "m"(d36bc0_ma710), [d69e0] "m"(d36bc0_d69e0), [d6b40] "m"(d36bc0_d6b40), [get] "m"(d36bc0_get), [ftol] "m"(d36bc0_ftol)
      : "memory");
}
#else
...
#if defined(__clang__)
static void (*const d377d0_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const d377d0_exitfn)(int) = system_exit;
static int (*const d377d0_o9ec30)(int, int, int, short, float, float, int, int) = FUN_0009ec30;
static bool (*const d377d0_gerun)(void) = game_engine_running;
static float (*const d377d0_g5590)(short) = FUN_000b5590;
static float (*const d377d0_g55b0)(short, int) = FUN_000b55b0;
static void (*const d377d0_d7170)(float *, float *, int, int, short, float *) = FUN_00137170;
static void (*const d377d0_odepl)(int) = object_deplete_body;
static void (*const d377d0_odest)(int) = object_destroy;
...
void FUN_001377d0(int object_handle __attribute__((unused)), int region_index __attribute__((unused)), int node_index __attribute__((unused)), unsigned int param_4 __attribute__((unused)), void *collision_model __attribute__((unused)), void *material __attribute__((unused)), void *damage_effect __attribute__((unused)), void *damage_params __attribute__((unused)), unsigned int *flags __attribute__((unused)), float *body_damage __attribute__((unused)), void **param_11 __attribute__((unused)), float scale __attribute__((unused)))
{
  __asm__ volatile(
      ...
      "fmuls 0x3c(%%ecx,%%edx,4)\n\t"
      "fstps 0x34(%%ebp)\n\t"
      "jne .LFUN_001377d0_13\n\t"
      "flds -0x4(%%ebp)\n\t"
      "fcomps 0x2533c0\n\t"
      "fnstsw %%ax\n\t"
      "testb $0x41, %%ah\n\t"
      "jne .LFUN_001377d0_12\n\t"
      "testb $1, 0x20(%%ebx)\n\t"
      "je .LFUN_001377d0_12\n\t"
      "movl 0x4(%%ecx), %%eax\n\t"
      "testb $2, %%al\n\t"
      ...
      "je .LFUN_001377d0_15\n\t"
      "movswl %%ax, %%edi\n\t"
      "movzwl 0x124(%%esi), %%eax\n\t"
      "movl $1, %%edx\n\t"
      "movl %%edi, %%ecx\n\t"
      "shll %%cl, %%edx\n\t"
      "testl %%eax, %%edx\n\t"
      "jne .LFUN_001377d0_14\n\t"
      "movl 0x18(%%ebp), %%eax\n\t"
      "pushl $0x54\n\t"
      "addl $0x240, %%eax\n\t"
      "pushl %%edi\n\t"
      ...
      "setne %%al\n\t"
      "testb %%al, %%al\n\t"
      "jne .LFUN_001377d0_20\n\t"
      "cmpw $1, 0x64(%%esi)\n\t"
      "jne .LFUN_001377d0_21\n\t"
      "movl 0xc8(%%esi), %%eax\n\t"
      "cmpl %%ebx, %%eax\n\t"
      "je .LFUN_001377d0_21\n\t"
      ".LFUN_001377d0_18:\n\t"
      ...
      "movl 0xc4(%%eax), %%eax\n\t"
      "cmpl %%ebx, %%eax\n\t"
      "jne .LFUN_001377d0_18\n\t"
      "jmp .LFUN_001377d0_21\n\t"
      ".LFUN_001377d0_20:\n\t"
      "movl $0, 0x90(%%esi)\n\t"
      ".LFUN_001377d0_21:\n\t"
      "pushl $-1\n\t"
      ...
      "fstp %%st(0)\n\t"
      "testb $4, %%al\n\t"
      "jne .LFUN_001377d0_27\n\t"
      "movl 0x18(%%ebp), %%esi\n\t"
      "movl 0x240(%%esi), %%eax\n\t"
      "addl $0x240, %%esi\n\t"
      "xorl %%ebx, %%ebx\n\t"
      "testl %%eax, %%eax\n\t"
      "jle .LFUN_001377d0_25\n\t"
      "xorl %%eax, %%eax\n\t"
      ".LFUN_001377d0_23:\n\t"
      "pushl $0x54\n\t"
      "pushl %%eax\n\t"
      ...
      "popl %%ebp\n\t"
      :
      : [assert] "m"(d377d0_assert), [exitfn] "m"(d377d0_exitfn), [o9ec30] "m"(d377d0_o9ec30), [gerun] "m"(d377d0_gerun), [g5590] "m"(d377d0_g5590), [g55b0] "m"(d377d0_g55b0), [d7170] "m"(d377d0_d7170), [odepl] "m"(d377d0_odepl), [odest] "m"(d377d0_odest), [d7690] "m"(d377d0_d7690), [get] "m"(d377d0_get), [elem] "m"(d377d0_elem), [ftol] "m"(d377d0_ftol)
      : "memory");
}
#else
