...
/* FUN_00075800 (0x75800) — XBE naked draft (batch 246). */
#if defined(__clang__)
static void (*const b75800_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b75800_exitfn)(int) = system_exit;
static void * (*const b75800_c7e3f0)(unsigned short width, unsigned short mipmap_count, unsigned short format) = bitmap_cube_map_new;
static int (*const b75800_c1d98ad)(void *stream, const char *format, ...) = crt_fprintf;
static int (*const b75800_c1d9bd2)(void *stream) = crt_fflush;
static void (*const b75800_c7ece0)(void) = bitmap_cube_map_face_insert;
static void (*const b75800_c7c8f0)(void *) = bitmap_delete;
static short (*const b75800_c75380)(void *bitmap /* */) = FUN_00075380;
static void *(*const b75800_elem)(void *, int, int) = tag_block_get_element;
static void (*const b75800_c8f390)(unsigned __int16 a1, const char *a2, ...) = error;
...
void FUN_00075800(void)
{
  __asm__ volatile(
      ...
      "movw -0xc(%%ebp), %%cx\n\t"
      "cmpw %%cx, 0x4(%%esi)\n\t"
      "jne .LFUN_00075800_16\n\t"
      "movl (%%esi), %%eax\n\t"
      "movw 0x4(%%eax), %%dx\n\t"
      "cmpw 0x4(%%edi), %%dx\n\t"
      "jne .LFUN_00075800_15\n\t"
      "movw 0x6(%%eax), %%cx\n\t"
      "cmpw 0x6(%%edi), %%cx\n\t"
      "jne .LFUN_00075800_15\n\t"
      "pushl %%ebx\n\t"
      ...
      "addl $8, %%esp\n\t"
      "movb $0, -0x1(%%ebp)\n\t"
      "jmp .LFUN_00075800_11\n\t"
      :
      : [assert] "m"(b75800_assert), [exitfn] "m"(b75800_exitfn), [c7e3f0] "m"(b75800_c7e3f0), [c1d98ad] "m"(b75800_c1d98ad), [c1d9bd2] "m"(b75800_c1d9bd2), [c7ece0] "m"(b75800_c7ece0), [c7c8f0] "m"(b75800_c7c8f0), [c75380] "m"(b75800_c75380), [elem] "m"(b75800_elem), [c8f390] "m"(b75800_c8f390)
      : "memory");
}
#else
#error "FUN_00075800: clang naked draft required"
#endif


/* FUN_00075a20 (0x75a20) — XBE naked draft (batch 257). */
#if defined(__clang__)
static void (*const b75a20_c8f390)(unsigned __int16 a1, const char *a2, ...) = error;
static void (*const b75a20_c747d0)(void) = FUN_000747d0;
static void * (*const b75a20_c7e0b0)(unsigned short width, unsigned short height, unsigned short mipmap_count, unsigned short format) = bitmap_2d_new;
static void (*const b75a20_c77510)(void *bitmap, int fill_color) = FUN_00077510;
static void *(*const b75a20_elem)(void *, int, int) = tag_block_get_element;
static void (*const b75a20_c11fef0)(void) = FUN_0011fef0;
static void (*const b75a20_c72490)(void) = FUN_00072490;
static void (*const b75a20_c7c8f0)(void *) = bitmap_delete;
static short (*const b75a20_c75380)(void *bitmap /* */) = FUN_00075380;
static void (*const b75a20_c11fd10)(void) = FUN_0011fd10;
static int (*const b75a20_c1d98ad)(void *stream, const char *format, ...) = crt_fprintf;
static int (*const b75a20_c1d9bd2)(void *stream) = crt_fflush;
static void (*const b75a20_c11fe80)(void) = FUN_0011fe80;
...
void FUN_00075a20(void)
{
  __asm__ volatile(
      ...
      ".LFUN_00075a20_11:\n\t"
      "cmpw -0x1c(%%ebp), %%bx\n\t"
      "jge .LFUN_00075a20_21\n\t"
      "movswl %%bx, %%edx\n\t"
      "movl -0xc0(%%ebp,%%edx,4), %%edi\n\t"
      "xorl %%eax, %%eax\n\t"
      "movw 0xa(%%edi), %%ax\n\t"
      "xorl %%ecx, %%ecx\n\t"
      "movw 0x8(%%edi), %%cx\n\t"
      ...
      "movw 0x20(%%edx), %%cx\n\t"
      "cmpw $-1, %%cx\n\t"
      "jne .LFUN_00075a20_14\n\t"
      "movw -0xc(%%ebp), %%cx\n\t"
      "movw %%cx, 0x20(%%edx)\n\t"
      "movw $1, 0x22(%%edx)\n\t"
      "jmp .LFUN_00075a20_15\n\t"
      ".LFUN_00075a20_14:\n\t"
      "movl -0xc(%%ebp), %%esi\n\t"
      "subl %%ecx, %%esi\n\t"
      "movw %%si, 0x22(%%edx)\n\t"
      ...
      "ret\n\t"
      :
      : [c8f390] "m"(b75a20_c8f390), [c747d0] "m"(b75a20_c747d0), [c7e0b0] "m"(b75a20_c7e0b0), [c77510] "m"(b75a20_c77510), [elem] "m"(b75a20_elem), [c11fef0] "m"(b75a20_c11fef0), [c72490] "m"(b75a20_c72490), [c7c8f0] "m"(b75a20_c7c8f0), [c75380] "m"(b75a20_c75380), [c11fd10] "m"(b75a20_c11fd10), [c1d98ad] "m"(b75a20_c1d98ad), [c1d9bd2] "m"(b75a20_c1d9bd2), [c11fe80] "m"(b75a20_c11fe80)
      : "memory");
}
#else
#error "FUN_00075a20: clang naked draft required"
#endif


/* FUN_00075e70 (0x75e70) — XBE naked draft (batch 241). */
#if defined(__clang__)
static void (*const b75e70_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b75e70_exitfn)(int) = system_exit;
static void (*const b75e70_c73e40)(void) = FUN_00073e40;
static void * (*const b75e70_c7e0b0)(unsigned short width, unsigned short height, unsigned short mipmap_count, unsigned short format) = bitmap_2d_new;
static void * (*const b75e70_c7c940)(void *bitmap, short x, short y, short mipmap_index) = bitmap_2d_address;
static int (*const b75e70_c1d98ad)(void *stream, const char *format, ...) = crt_fprintf;
static int (*const b75e70_c1d9bd2)(void *stream) = crt_fflush;
static void (*const b75e70_c8f390)(unsigned __int16 a1, const char *a2, ...) = error;
static void (*const b75e70_c73b00)(void) = FUN_00073b00;
static void (*const b75e70_c7c8f0)(void *) = bitmap_delete;
static int16_t (*const b75e70_c1b9ad0)(void *tag_block) = tag_block_add_element;
static void *(*const b75e70_elem)(void *, int, int) = tag_block_get_element;
static short (*const b75e70_c75380)(void *bitmap /* */) = FUN_00075380;
...
void FUN_00075e70(void)
{
  __asm__ volatile(
      ...
      "movb 0x334148, %%cl\n\t"
      "testb %%cl, %%cl\n\t"
      "jne .LFUN_00075e70_21\n\t"
      "cmpw $2, %%ax\n\t"
      "jne .LFUN_00075e70_20\n\t"
      "pushl %%ebx\n\t"
      "call *%[c73b00]\n\t"
      "addl $4, %%esp\n\t"
      ".LFUN_00075e70_18:\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(b75e70_assert), [exitfn] "m"(b75e70_exitfn), [c73e40] "m"(b75e70_c73e40), [c7e0b0] "m"(b75e70_c7e0b0), [c7c940] "m"(b75e70_c7c940), [c1d98ad] "m"(b75e70_c1d98ad), [c1d9bd2] "m"(b75e70_c1d9bd2), [c8f390] "m"(b75e70_c8f390), [c73b00] "m"(b75e70_c73b00), [c7c8f0] "m"(b75e70_c7c8f0), [c1b9ad0] "m"(b75e70_c1b9ad0), [elem] "m"(b75e70_elem), [c75380] "m"(b75e70_c75380)
      : "memory");
}
#else
#error "FUN_00075e70: clang naked draft required"
#endif
...
#if defined(__clang__)
static bool (*const b7b510_c7d470)(void *bitmap, int check_hardware) = bitmap_verify;
static void (*const b7b510_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b7b510_exitfn)(int) = system_exit;
static int (*const b7b510_c7e040)(void *bitmap_data) = bitmap_get_pixel_data_size;
static void * (*const b7b510_c8ee60)(uint32_t size, bool zero, const char *file, int line) = debug_malloc;
static void * (*const b7b510_c7c940)(void *bitmap, short x, short y, short mipmap_index) = bitmap_2d_address;
static void * (*const b7b510_c7d000)(void *bitmap, short mipmap_index) = bitmap_mipmap_address;
static void * (*const b7b510_c8e0b0)(void *destination, void *source, size_t size) = csmemcpy;
static void (*const b7b510_c8ef70)(void *ptr, const char *file, int line) = debug_free;
static void (*const b7b510_c8f390)(unsigned __int16 a1, const char *a2, ...) = error;

__attribute__((naked, noinline))
void FUN_0007b510(float bump_height __attribute__((unused)), void *bitmap /* */ __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "fmuls 0x261518\n\t"
      "fstps -0x8(%%ebp)\n\t"
      "jle .LFUN_0007b510_30\n\t"
      ".LFUN_0007b510_4:\n\t"
      "xorl %%edi, %%edi\n\t"
      "cmpw %%di, 0x4(%%esi)\n\t"
      "jle .LFUN_0007b510_29\n\t"
      "leal (%%esp), %%esp\n\t"
      ".LFUN_0007b510_5:\n\t"
      "pushl $0\n\t"
      "pushl %%ebx\n\t"
      ...
      "addl $0x10, %%esp\n\t"
      "testw %%ax, %%ax\n\t"
      "jne .LFUN_0007b510_10\n\t"
      "movswl 0x6(%%esi), %%eax\n\t"
      "jmp .LFUN_0007b510_11\n\t"
      ".LFUN_0007b510_10:\n\t"
      "movswl %%ax, %%eax\n\t"
      ".LFUN_0007b510_11:\n\t"
      "pushl $0\n\t"
      ...
      "decl %%edx\n\t"
      "cmpl %%edx, %%ecx\n\t"
      "jne .LFUN_0007b510_12\n\t"
      "xorl %%edx, %%edx\n\t"
      "jmp .LFUN_0007b510_13\n\t"
      ".LFUN_0007b510_12:\n\t"
      "leal 0x1(%%ecx), %%edx\n\t"
      ".LFUN_0007b510_13:\n\t"
      "movl -0x1c(%%ebp), %%ecx\n\t"
      ...
      "jne .LFUN_0007b510_18\n\t"
      "movl $0, -0x4c(%%ebp)\n\t"
      "jmp .LFUN_0007b510_20\n\t"
      ".LFUN_0007b510_18:\n\t"
      "flds -0xc(%%ebp)\n\t"
      "fcomps -0x10(%%ebp)\n\t"
      "fnstsw %%ax\n\t"
      "testb $0x41, %%ah\n\t"
      "jne .LFUN_0007b510_19\n\t"
      "flds -0xc(%%ebp)\n\t"
      "movl $0xbf800000, -0x54(%%ebp)\n\t"
      "fsubs 0x8(%%ebp)\n\t"
      "fstps -0x4c(%%ebp)\n\t"
      "jmp .LFUN_0007b510_21\n\t"
      ".LFUN_0007b510_19:\n\t"
      "flds -0x10(%%ebp)\n\t"
      "fsubs 0x8(%%ebp)\n\t"
      "fstps -0x4c(%%ebp)\n\t"
      ...
      "jne .LFUN_0007b510_22\n\t"
      "movl $0, -0x40(%%ebp)\n\t"
      "jmp .LFUN_0007b510_24\n\t"
      ".LFUN_0007b510_22:\n\t"
      "flds -0x14(%%ebp)\n\t"
      "fcomps -0x18(%%ebp)\n\t"
      "fnstsw %%ax\n\t"
      "testb $0x41, %%ah\n\t"
      "jne .LFUN_0007b510_23\n\t"
      "flds -0x14(%%ebp)\n\t"
      "movl $0xbf800000, -0x44(%%ebp)\n\t"
      "fsubs 0x8(%%ebp)\n\t"
      "fstps -0x40(%%ebp)\n\t"
      "jmp .LFUN_0007b510_25\n\t"
      ".LFUN_0007b510_23:\n\t"
      "flds -0x18(%%ebp)\n\t"
      "fsubs 0x8(%%ebp)\n\t"
      "fstps -0x40(%%ebp)\n\t"
      ...
      "ret\n\t"
      :
      : [c7d470] "m"(b7b510_c7d470), [assert] "m"(b7b510_assert), [exitfn] "m"(b7b510_exitfn), [c7e040] "m"(b7b510_c7e040), [c8ee60] "m"(b7b510_c8ee60), [c7c940] "m"(b7b510_c7c940), [c7d000] "m"(b7b510_c7d000), [c8e0b0] "m"(b7b510_c8e0b0), [c8ef70] "m"(b7b510_c8ef70), [c8f390] "m"(b7b510_c8f390)
      : "memory");
}
#else
#error "FUN_0007b510: clang naked draft required"
#endif


/* FUN_0007b940 (0x7b940) — XBE naked draft (batch 257). */
#if defined(__clang__)
static bool (*const b7b940_c7d470)(void *bitmap, int check_hardware) = bitmap_verify;
static void (*const b7b940_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b7b940_exitfn)(int) = system_exit;
static void * (*const b7b940_c7e0b0)(unsigned short width, unsigned short height, unsigned short mipmap_count, unsigned short format) = bitmap_2d_new;
static void (*const b7b940_c7e560)(void) = bitmap_3d_slice_insert;
static void (*const b7b940_c7b510)(float bump_height, void *bitmap /* */) = FUN_0007b510;
static void (*const b7b940_c7e7e0)(void *src_bitmap, void *dst_bitmap, int face, int slice) = bitmap_cube_map_face_extract;
static void (*const b7b940_c7c8f0)(void *) = bitmap_delete;
static void (*const b7b940_c8f390)(unsigned __int16 a1, const char *a2, ...) = error;

__attribute__((naked, noinline))
void FUN_0007b940(float bump_height __attribute__((unused)), void *bitmap /* */ __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [c7d470] "m"(b7b940_c7d470), [assert] "m"(b7b940_assert), [exitfn] "m"(b7b940_exitfn), [c7e0b0] "m"(b7b940_c7e0b0), [c7e560] "m"(b7b940_c7e560), [c7b510] "m"(b7b940_c7b510), [c7e7e0] "m"(b7b940_c7e7e0), [c7c8f0] "m"(b7b940_c7c8f0), [c8f390] "m"(b7b940_c8f390)
      : "memory");
}
#else
#error "FUN_0007b940: clang naked draft required"
#endif
...
/* FUN_00079480 (0x79480) — XBE naked draft (batch 258). */
#if defined(__clang__)
static bool (*const b79480_c7d470)(void *bitmap, int check_hardware) = bitmap_verify;
static void (*const b79480_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b79480_exitfn)(int) = system_exit;
static void * (*const b79480_c7e0b0)(unsigned short width, unsigned short height, unsigned short mipmap_count, unsigned short format) = bitmap_2d_new;
static void (*const b79480_c7e560)(void) = bitmap_3d_slice_insert;
static void (*const b79480_c79250)(short passes /* */, void *bitmap) = FUN_00079250;
static void (*const b79480_c7e7e0)(void *src_bitmap, void *dst_bitmap, int face, int slice) = bitmap_cube_map_face_extract;
static void (*const b79480_c7c8f0)(void *) = bitmap_delete;
static void (*const b79480_c8f390)(unsigned __int16 a1, const char *a2, ...) = error;

__attribute__((naked, noinline))
void FUN_00079480(short passes __attribute__((unused)), void *bitmap /* */ __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [c7d470] "m"(b79480_c7d470), [assert] "m"(b79480_assert), [exitfn] "m"(b79480_exitfn), [c7e0b0] "m"(b79480_c7e0b0), [c7e560] "m"(b79480_c7e560), [c79250] "m"(b79480_c79250), [c7e7e0] "m"(b79480_c7e7e0), [c7c8f0] "m"(b79480_c7c8f0), [c8f390] "m"(b79480_c8f390)
      : "memory");
}
#else
#error "FUN_00079480: clang naked draft required"
#endif
