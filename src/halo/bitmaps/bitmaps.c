...
#if defined(__clang__)
static bool (*const b7c070_c7d470)(void *bitmap, int check_hardware) = bitmap_verify;
static void (*const b7c070_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b7c070_exitfn)(int) = system_exit;
static void (*const b7c070_c7a4a0)(void) = bitmap_2d_uncompress_from_mipmap;
static void (*const b7c070_c7a1e0)(void) = FUN_0007a1e0;
static void (*const b7c070_c79e70)(void) = FUN_00079e70;
...
void bitmap_3d_compress_to_mipmap(void)
{
  __asm__ volatile(
      ...
      "addl $8, %%esp\n\t"
      "testb %%al, %%al\n\t"
      "jne .Lbitmap_3d_compress_to_mipmap_1\n\t"
      "pushl $1\n\t"
      "pushl $0x746\n\t"
      "pushl $0x2641f0\n\t"
      "pushl $0x261b44\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lbitmap_3d_compress_to_mipmap_1:\n\t"
      "movl 0x10(%%ebp), %%ebx\n\t"
      "testw %%bx, %%bx\n\t"
      "jl .Lbitmap_3d_compress_to_mipmap_2\n\t"
      "cmpw 0x14(%%esi), %%bx\n\t"
      "jle .Lbitmap_3d_compress_to_mipmap_3\n\t"
      ".Lbitmap_3d_compress_to_mipmap_2:\n\t"
      "pushl $1\n\t"
      "pushl $0x747\n\t"
      "pushl $0x2641f0\n\t"
      "pushl $0x261ac8\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lbitmap_3d_compress_to_mipmap_3:\n\t"
      "xorl %%eax, %%eax\n\t"
      "movw 0x4(%%esi), %%ax\n\t"
      "movw %%bx, %%cx\n\t"
      "movl %%eax, %%edx\n\t"
      "sarw %%cl, %%dx\n\t"
      "cmpw $1, %%dx\n\t"
      "jge .Lbitmap_3d_compress_to_mipmap_4\n\t"
      "movl $1, %%eax\n\t"
      "jmp .Lbitmap_3d_compress_to_mipmap_5\n\t"
      ".Lbitmap_3d_compress_to_mipmap_4:\n\t"
      "movswl %%ax, %%eax\n\t"
      "movb %%bl, %%cl\n\t"
      "sarl %%cl, %%eax\n\t"
      ".Lbitmap_3d_compress_to_mipmap_5:\n\t"
      "movl 0xc(%%ebp), %%edi\n\t"
      "movswl 0x4(%%edi), %%ecx\n\t"
      "cmpl %%ecx, %%eax\n\t"
      "je .Lbitmap_3d_compress_to_mipmap_6\n\t"
      "pushl $1\n\t"
      "pushl $0x748\n\t"
      "pushl $0x2641f0\n\t"
      "pushl $0x264770\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lbitmap_3d_compress_to_mipmap_6:\n\t"
      "xorl %%eax, %%eax\n\t"
      "movw 0x6(%%esi), %%ax\n\t"
      "movw %%bx, %%cx\n\t"
      "movl %%eax, %%edx\n\t"
      "sarw %%cl, %%dx\n\t"
      "cmpw $1, %%dx\n\t"
      "jge .Lbitmap_3d_compress_to_mipmap_7\n\t"
      "movl $1, %%eax\n\t"
      "jmp .Lbitmap_3d_compress_to_mipmap_8\n\t"
      ".Lbitmap_3d_compress_to_mipmap_7:\n\t"
      "movswl %%ax, %%eax\n\t"
      "movb %%bl, %%cl\n\t"
      "sarl %%cl, %%eax\n\t"
      ".Lbitmap_3d_compress_to_mipmap_8:\n\t"
      "movswl 0x6(%%edi), %%ecx\n\t"
      "cmpl %%ecx, %%eax\n\t"
      "je .Lbitmap_3d_compress_to_mipmap_9\n\t"
      "pushl $1\n\t"
      "pushl $0x749\n\t"
      "pushl $0x2641f0\n\t"
      "pushl $0x264720\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lbitmap_3d_compress_to_mipmap_9:\n\t"
      "xorl %%eax, %%eax\n\t"
      "movw 0x8(%%esi), %%ax\n\t"
      "movw %%bx, %%cx\n\t"
      "movl %%eax, %%edx\n\t"
      "sarw %%cl, %%dx\n\t"
      "cmpw $1, %%dx\n\t"
      "jge .Lbitmap_3d_compress_to_mipmap_10\n\t"
      "movl $1, %%eax\n\t"
      "jmp .Lbitmap_3d_compress_to_mipmap_11\n\t"
      ".Lbitmap_3d_compress_to_mipmap_10:\n\t"
      "movswl %%ax, %%eax\n\t"
      "movb %%bl, %%cl\n\t"
      "sarl %%cl, %%eax\n\t"
      ".Lbitmap_3d_compress_to_mipmap_11:\n\t"
      "movswl 0x8(%%edi), %%ecx\n\t"
      "cmpl %%ecx, %%eax\n\t"
      "je .Lbitmap_3d_compress_to_mipmap_12\n\t"
      "pushl $1\n\t"
      "pushl $0x74a\n\t"
      "pushl $0x2641f0\n\t"
      "pushl $0x2646d0\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lbitmap_3d_compress_to_mipmap_12:\n\t"
      "testb $2, 0xe(%%esi)\n\t"
      "jne .Lbitmap_3d_compress_to_mipmap_13\n\t"
      "pushl $1\n\t"
      "pushl $0x74b\n\t"
      "pushl $0x2641f0\n\t"
      "pushl $0x264694\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lbitmap_3d_compress_to_mipmap_13:\n\t"
      "pushl $1\n\t"
      "pushl %%edi\n\t"
      "call *%[c7d470]\n\t"
      "addl $8, %%esp\n\t"
      "testb %%al, %%al\n\t"
      "jne .Lbitmap_3d_compress_to_mipmap_14\n\t"
      "pushl $1\n\t"
      "pushl $0x74d\n\t"
      "pushl $0x2641f0\n\t"
      "pushl $0x261c58\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lbitmap_3d_compress_to_mipmap_14:\n\t"
      "movswl 0xa(%%esi), %%eax\n\t"
      "subl $0, %%eax\n\t"
      "je .Lbitmap_3d_compress_to_mipmap_17\n\t"
      "decl %%eax\n\t"
      "je .Lbitmap_3d_compress_to_mipmap_16\n\t"
      "decl %%eax\n\t"
      "je .Lbitmap_3d_compress_to_mipmap_15\n\t"
      "pushl $1\n\t"
      "pushl $0x75b\n\t"
      "pushl $0x2641f0\n\t"
      "pushl $0x261d30\n\t"
      ...
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lbitmap_3d_compress_to_mipmap_15:\n\t"
      "pushl %%ebx\n\t"
      "pushl %%edi\n\t"
      "pushl %%esi\n\t"
      "call *%[c7a4a0]\n\t"
      ...
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lbitmap_3d_compress_to_mipmap_16:\n\t"
      "pushl %%ebx\n\t"
      "pushl %%edi\n\t"
      "pushl %%esi\n\t"
      "call *%[c7a1e0]\n\t"
      ...
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lbitmap_3d_compress_to_mipmap_17:\n\t"
      "pushl %%ebx\n\t"
      "pushl %%edi\n\t"
      "pushl %%esi\n\t"
      "call *%[c79e70]\n\t"
      ...
      "ret\n\t"
      :
      : [c7d470] "m"(b7c070_c7d470), [assert] "m"(b7c070_assert), [exitfn] "m"(b7c070_exitfn), [c7a4a0] "m"(b7c070_c7a4a0), [c7a1e0] "m"(b7c070_c7a1e0), [c79e70] "m"(b7c070_c79e70)
      : "memory");
}
#else
#error "bitmap_3d_compress_to_mipmap: clang naked draft required"
#endif
...
#if defined(__clang__)
static bool (*const b7e040_c7d470)(void *bitmap, int check_hardware) = bitmap_verify;
static void (*const b7e040_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b7e040_exitfn)(int) = system_exit;
static int (*const b7e040_c7dfe0)(void *bitmap) = bitmap_get_pixel_count;
static short (*const b7e040_c7c840)(short format) = bitmap_format_bits_per_pixel;

__attribute__((naked, noinline))
int bitmap_get_pixel_data_size(void *bitmap_data __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "addl $8, %%esp\n\t"
      "testb %%al, %%al\n\t"
      "jne .Lbitmap_get_pixel_data_size_1\n\t"
      "pushl $1\n\t"
      "pushl $0x38a\n\t"
      "pushl $0x264a74\n\t"
      "pushl $0x264da0\n\t"
      ...
      "ret\n\t"
      :
      : [c7d470] "m"(b7e040_c7d470), [assert] "m"(b7e040_assert), [exitfn] "m"(b7e040_exitfn), [c7dfe0] "m"(b7e040_c7dfe0), [c7c840] "m"(b7e040_c7c840)
      : "memory");
}
#else
#error "bitmap_get_pixel_data_size: clang naked draft required"
#endif
