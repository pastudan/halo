...
/* FUN_001ca130 (0x1ca130) — XBE naked draft (batch 248). */
#if defined(__clang__)
static void (*const b1ca130_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b1ca130_exitfn)(int) = system_exit;
static bool __stdcall (*const b1ca130_c20f069)(void *stream) = dsound_stream_is_active;
static void (*const b1ca130_c8f390)(unsigned __int16 a1, const char *a2, ...) = error;
...
void FUN_001ca130(void)
{
  __asm__ volatile(
      ...
      "movswl %%di, %%esi\n\t"
      "imull $0x74, %%esi, %%esi\n\t"
      "movb 0x4fdfce(%%esi), %%al\n\t"
      "cmpb %%bl, %%al\n\t"
      "leal 0x4fdfc8(%%esi), %%esi\n\t"
      "jne .LFUN_001ca130_6\n\t"
      "cmpw %%bx, (%%esi)\n\t"
      "je .LFUN_001ca130_5\n\t"
      "pushl $1\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(b1ca130_assert), [exitfn] "m"(b1ca130_exitfn), [c20f069] "m"(b1ca130_c20f069), [c8f390] "m"(b1ca130_c8f390)
      : "memory");
}
#else
#error "FUN_001ca130: clang naked draft required"
#endif
...
void FUN_001ca970(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1c9290] "m"(b1ca970_c1c9290), [c1c9350] "m"(b1ca970_c1c9350), [c1be140] "m"(b1ca970_c1be140), [c1ca900] "m"(b1ca970_c1ca900), [c8df60] "m"(b1ca970_c8df60), [c1d90f0] "m"(b1ca970_c1d90f0)
      : "memory");
}
#else
#error "FUN_001ca970: clang naked draft required"
#endif


/* FUN_001caab0 (0x1caab0) — XBE naked draft (batch 243). */
#if defined(__clang__)
static void (*const b1caab0_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b1caab0_exitfn)(int) = system_exit;
static bool __stdcall (*const b1caab0_c20f069)(void *stream) = dsound_stream_is_active;
...
void FUN_001caab0(void)
{
  __asm__ volatile(
      ...
      "movb %%al, -0x1(%%ebp)\n\t"
      "je .LFUN_001caab0_6\n\t"
      "movl 0x4fe038(%%esi), %%eax\n\t"
      "movl (%%eax), %%edx\n\t"
      "pushl %%eax\n\t"
      "call *0x18(%%edx)\n\t"
      "movb %%bl, 0x4fdfce(%%esi)\n\t"
      ".LFUN_001caab0_11:\n\t"
      "movw 0x4fdfc4, %%ax\n\t"
      "incl %%edi\n\t"
      "cmpw %%ax, %%di\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(b1caab0_assert), [exitfn] "m"(b1caab0_exitfn), [c20f069] "m"(b1caab0_c20f069), [ftol] "m"(b1caab0_ftol), [c2053ac] "m"(b1caab0_c2053ac), [c8f390] "m"(b1caab0_c8f390), [c1ca900] "m"(b1caab0_c1ca900)
      : "memory");
}
#else
#error "FUN_001caab0: clang naked draft required"
#endif
