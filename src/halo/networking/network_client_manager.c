...
#if defined(__clang__)
static void (*const b124e90_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b124e90_exitfn)(int) = system_exit;
static unsigned int (*const b124e90_c8e370)(void) = system_milliseconds;
static void (*const b124e90_c12b650)(const char *fmt, ...) = network_game_log;

__attribute__((naked, noinline))
void network_game_client_ponged(void *client __attribute__((unused)), void *source __attribute__((unused)), int timestamp __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "pushl %%edi\n\t"
      "movl 0xc(%%ebp), %%edi\n\t"
      "je .Lnetwork_game_client_ponged_1\n\t"
      "testl %%edi, %%edi\n\t"
      "jne .Lnetwork_game_client_ponged_2\n\t"
      ".Lnetwork_game_client_ponged_1:\n\t"
      "pushl $1\n\t"
      "pushl $0x307\n\t"
      "pushl $0x291774\n\t"
      "pushl $0x291a3c\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lnetwork_game_client_ponged_2:\n\t"
      "movb 0x82a(%%esi), %%al\n\t"
      "testb %%al, %%al\n\t"
      "je .Lnetwork_game_client_ponged_4\n\t"
      "movl 0x808(%%esi), %%eax\n\t"
      "cmpl (%%edi), %%eax\n\t"
      "jne .Lnetwork_game_client_ponged_4\n\t"
      "call *%[c8e370]\n\t"
      "movl 0x10(%%ebp), %%ebx\n\t"
      "movl %%eax, %%edi\n\t"
      "cmpl %%edi, %%ebx\n\t"
      "ja .Lnetwork_game_client_ponged_3\n\t"
      "movw 0x826(%%esi), %%cx\n\t"
      "movzwl 0x828(%%esi), %%eax\n\t"
      "movzwl %%cx, %%edx\n\t"
      "imull %%edx, %%eax\n\t"
      "subl %%ebx, %%eax\n\t"
      "addl %%edi, %%eax\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(b124e90_assert), [exitfn] "m"(b124e90_exitfn), [c8e370] "m"(b124e90_c8e370), [c12b650] "m"(b124e90_c12b650)
      : "memory");
}
#else
#error "network_game_client_ponged: clang naked draft required"
#endif


/* network_game_client_accepted_into_game (0x124f40) — XBE naked draft (batch 130). */
#if defined(__clang__)
static void (*const b124f40_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b124f40_exitfn)(int) = system_exit;
static void (*const b124f40_c12a060)(int seed) = network_game_set_random_seed;
static void (*const b124f40_c12b650)(const char *fmt, ...) = network_game_log;
static void (*const b124f40_c12aaf0)(void *name_buffer) = network_game_generate_local_machine_name;
static void * (*const b124f40_c12b700)(int type, void *data, int16_t message_struct_size) = encode_network_game_message;
static bool (*const b124f40_c128e00)(void *connection, void *message, unsigned short size, int dest_address, bool reliable) = network_connection_write;

__attribute__((naked, noinline))
void network_game_client_accepted_into_game(void *client __attribute__((unused)), void *source __attribute__((unused)), void *message __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "movl 0x8(%%ebp), %%edi\n\t"
      "testl %%edi, %%edi\n\t"
      "je .Lnetwork_game_client_accepted_into_game_1\n\t"
      "movl 0xc(%%ebp), %%eax\n\t"
      "testl %%eax, %%eax\n\t"
      "je .Lnetwork_game_client_accepted_into_game_1\n\t"
      "testl %%esi, %%esi\n\t"
      "je .Lnetwork_game_client_accepted_into_game_1\n\t"
      "cmpw $1, 0xca6(%%edi)\n\t"
      "je .Lnetwork_game_client_accepted_into_game_2\n\t"
      ".Lnetwork_game_client_accepted_into_game_1:\n\t"
      "pushl $1\n\t"
      "pushl $0x327\n\t"
      "pushl $0x291774\n\t"
      "pushl $0x291b70\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lnetwork_game_client_accepted_into_game_2:\n\t"
      "movw 0x4(%%esi), %%ax\n\t"
      "testw %%ax, %%ax\n\t"
      "jl .Lnetwork_game_client_accepted_into_game_4\n\t"
      "cmpw $4, %%ax\n\t"
      "jge .Lnetwork_game_client_accepted_into_game_4\n\t"
      "movw %%ax, (%%edi)\n\t"
      "movswl 0x4(%%esi), %%eax\n\t"
      "movb 0x4(%%esi), %%cl\n\t"
      "imull $0x44, %%eax, %%eax\n\t"
      "movb %%cl, 0x9b0(%%eax,%%edi,1)\n\t"
      "movw $2, 0xca6(%%edi)\n\t"
      "movl (%%esi), %%edx\n\t"
      "pushl %%edx\n\t"
      "call *%[c12a060]\n\t"
      ...
      "addl $0x1c, %%esp\n\t"
      "testl %%eax, %%eax\n\t"
      "je .Lnetwork_game_client_accepted_into_game_3\n\t"
      "movl 0x82c(%%edi), %%edi\n\t"
      "xorl %%ecx, %%ecx\n\t"
      "movw (%%eax), %%cx\n\t"
      "shrw $4, %%cx\n\t"
      ...
      "addl $0x14, %%esp\n\t"
      "testb %%al, %%al\n\t"
      "jne .Lnetwork_game_client_accepted_into_game_5\n\t"
      "pushl $0x291ae0\n\t"
      "call *%[c12b650]\n\t"
      "addl $4, %%esp\n\t"
      "popl %%edi\n\t"
      ...
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lnetwork_game_client_accepted_into_game_3:\n\t"
      "pushl $0x291aa4\n\t"
      "call *%[c12b650]\n\t"
      "addl $4, %%esp\n\t"
      "popl %%edi\n\t"
      ...
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lnetwork_game_client_accepted_into_game_4:\n\t"
      "pushl $0x291a58\n\t"
      "call *%[c12b650]\n\t"
      "addl $4, %%esp\n\t"
      ".Lnetwork_game_client_accepted_into_game_5:\n\t"
      "popl %%edi\n\t"
      "popl %%esi\n\t"
      "movl %%ebp, %%esp\n\t"
      "popl %%ebp\n\t"
      "ret\n\t"
      :
      : [assert] "m"(b124f40_assert), [exitfn] "m"(b124f40_exitfn), [c12a060] "m"(b124f40_c12a060), [c12b650] "m"(b124f40_c12b650), [c12aaf0] "m"(b124f40_c12aaf0), [c12b700] "m"(b124f40_c12b700), [c128e00] "m"(b124f40_c128e00)
      : "memory");
}
#else
#error "network_game_client_accepted_into_game: clang naked draft required"
#endif
...
/* network_game_client_update_local_player_data (0x125a90) — XBE naked draft (batch 129). */
#if defined(__clang__)
static void (*const b125a90_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b125a90_exitfn)(int) = system_exit;
static bool (*const b125a90_c12ac80)(void *client) = network_player_is_valid;
static void * (*const b125a90_c8e0b0)(void *destination, void *source, size_t size) = csmemcpy;
static void * (*const b125a90_c12b700)(int type, void *data, int16_t message_struct_size) = encode_network_game_message;
static bool (*const b125a90_c128e00)(void *connection, void *message, unsigned short size, int dest_address, bool reliable) = network_connection_write;
static void (*const b125a90_c12b650)(const char *fmt, ...) = network_game_log;

__attribute__((naked, noinline))
char network_game_client_update_local_player_data(void *client __attribute__((unused)), void *player __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "pushl %%edi\n\t"
      "movl 0xc(%%ebp), %%edi\n\t"
      "je .Lnetwork_game_client_update_local_player_data_1\n\t"
      "testl %%edi, %%edi\n\t"
      "jne .Lnetwork_game_client_update_local_player_data_2\n\t"
      ".Lnetwork_game_client_update_local_player_data_1:\n\t"
      "pushl $1\n\t"
      "pushl $0x587\n\t"
      "pushl $0x291774\n\t"
      "pushl $0x291f58\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lnetwork_game_client_update_local_player_data_2:\n\t"
      "movsbl 0x1c(%%edi), %%eax\n\t"
      "movzwl (%%esi), %%ecx\n\t"
      "cmpl %%ecx, %%eax\n\t"
      "je .Lnetwork_game_client_update_local_player_data_3\n\t"
      "pushl $1\n\t"
      "pushl $0x588\n\t"
      "pushl $0x291774\n\t"
      "pushl $0x2922b8\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lnetwork_game_client_update_local_player_data_3:\n\t"
      "pushl %%edi\n\t"
      "call *%[c12ac80]\n\t"
      "addl $4, %%esp\n\t"
      "testb %%al, %%al\n\t"
      "jne .Lnetwork_game_client_update_local_player_data_4\n\t"
      "pushl $1\n\t"
      "pushl $0x589\n\t"
      "pushl $0x291774\n\t"
      "pushl $0x292298\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lnetwork_game_client_update_local_player_data_4:\n\t"
      "pushl $0x20\n\t"
      "leal -0x20(%%ebp), %%edx\n\t"
      "pushl %%edi\n\t"
      "pushl %%edx\n\t"
      ...
      "addl $0xc, %%esp\n\t"
      "cmpb $0xff, %%al\n\t"
      "jne .Lnetwork_game_client_update_local_player_data_5\n\t"
      "movb $0, -0x2(%%ebp)\n\t"
      ".Lnetwork_game_client_update_local_player_data_5:\n\t"
      "pushl $0x20\n\t"
      "leal -0x20(%%ebp), %%eax\n\t"
      "pushl %%eax\n\t"
      "pushl $0x10\n\t"
      ...
      "addl $0xc, %%esp\n\t"
      "testl %%eax, %%eax\n\t"
      "je .Lnetwork_game_client_update_local_player_data_7\n\t"
      "movl 0x82c(%%esi), %%edx\n\t"
      "xorl %%ecx, %%ecx\n\t"
      "movw (%%eax), %%cx\n\t"
      "shrw $4, %%cx\n\t"
      ...
      "addl $0x14, %%esp\n\t"
      "testb %%al, %%al\n\t"
      "je .Lnetwork_game_client_update_local_player_data_6\n\t"
      "popl %%edi\n\t"
      "popl %%esi\n\t"
      "movb $1, %%al\n\t"
      "popl %%ebx\n\t"
      ...
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lnetwork_game_client_update_local_player_data_6:\n\t"
      "pushl $0x292220\n\t"
      "call *%[c12b650]\n\t"
      "addl $4, %%esp\n\t"
      ".Lnetwork_game_client_update_local_player_data_7:\n\t"
      "popl %%edi\n\t"
      "popl %%esi\n\t"
      "movb %%bl, %%al\n\t"
      "popl %%ebx\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(b125a90_assert), [exitfn] "m"(b125a90_exitfn), [c12ac80] "m"(b125a90_c12ac80), [c8e0b0] "m"(b125a90_c8e0b0), [c12b700] "m"(b125a90_c12b700), [c128e00] "m"(b125a90_c128e00), [c12b650] "m"(b125a90_c12b650)
      : "memory");
}
#else
#error "network_game_client_update_local_player_data: clang naked draft required"
#endif


/* FUN_00125b90 (0x125b90) — XBE naked draft (batch 139). */
#if defined(__clang__)
static void (*const b125b90_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b125b90_exitfn)(int) = system_exit;
static void * (*const b125b90_c12b700)(int type, void *data, int16_t message_struct_size) = encode_network_game_message;
static bool (*const b125b90_c128e00)(void *connection, void *message, unsigned short size, int dest_address, bool reliable) = network_connection_write;
static void (*const b125b90_c12b650)(const char *fmt, ...) = network_game_log;

__attribute__((naked, noinline))
char FUN_00125b90(void *client __attribute__((unused)), short request_type __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(b125b90_assert), [exitfn] "m"(b125b90_exitfn), [c12b700] "m"(b125b90_c12b700), [c128e00] "m"(b125b90_c128e00), [c12b650] "m"(b125b90_c12b650)
      : "memory");
}
#else
#error "FUN_00125b90: clang naked draft required"
#endif
...
#if defined(__clang__)
static void (*const b1267c0_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b1267c0_exitfn)(int) = system_exit;
static void (*const b1267c0_c12b150)(void *game) = network_game_invalidate;
static bool (*const b1267c0_c128360)(int connection) = network_connection_connected;
static bool (*const b1267c0_c129980)(int connection) = FUN_00129980;
static void (*const b1267c0_c125fb0)(void *client /* */, int16_t reason /* */) = FUN_00125fb0;
static void (*const b1267c0_c12b650)(const char *fmt, ...) = network_game_log;

__attribute__((naked, noinline))
void network_game_client_reset(void *client __attribute__((unused)), char flag __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "xorl %%ebx, %%ebx\n\t"
      "cmpl %%ebx, %%esi\n\t"
      "jne .Lnetwork_game_client_reset_1\n\t"
      "pushl $1\n\t"
      "pushl $0x4ee\n\t"
      "pushl $0x291774\n\t"
      "pushl $0x2917a8\n\t"
      ...
      "movw $0xffff, (%%esi)\n\t"
      "movw %%bx, 0xca6(%%esi)\n\t"
      "je .Lnetwork_game_client_reset_3\n\t"
      "movl 0x82c(%%esi), %%eax\n\t"
      "cmpl %%ebx, %%eax\n\t"
      "je .Lnetwork_game_client_reset_3\n\t"
      "pushl %%eax\n\t"
      ...
      "addl $4, %%esp\n\t"
      "testb %%al, %%al\n\t"
      "je .Lnetwork_game_client_reset_2\n\t"
      "andb $0xfe, 0xcaa(%%esi)\n\t"
      "jmp .Lnetwork_game_client_reset_3\n\t"
      ".Lnetwork_game_client_reset_2:\n\t"
      "movl $1, %%eax\n\t"
      "call *%[c125fb0]\n\t"
      "pushl $0x292af0\n\t"
      "call *%[c12b650]\n\t"
      "addl $4, %%esp\n\t"
      ".Lnetwork_game_client_reset_3:\n\t"
      "andb $0xfd, 0xcaa(%%esi)\n\t"
      "movw %%bx, 0xca8(%%esi)\n\t"
      "movl %%ebx, 0xc94(%%esi)\n\t"
      "movl %%ebx, 0xc98(%%esi)\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(b1267c0_assert), [exitfn] "m"(b1267c0_exitfn), [c12b150] "m"(b1267c0_c12b150), [c128360] "m"(b1267c0_c128360), [c129980] "m"(b1267c0_c129980), [c125fb0] "m"(b1267c0_c125fb0), [c12b650] "m"(b1267c0_c12b650)
      : "memory");
}
#else
#error "network_game_client_reset: clang naked draft required"
#endif
...
/* FUN_00127260 (0x127260) — XBE naked draft (batch 142). */
#if defined(__clang__)
...
__attribute__((naked, noinline))
char FUN_00127260(void *client /* */ __attribute__((unused)), void *message __attribute__((unused)), int message_size __attribute__((unused)), void *source_address __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [c124a30] "m"(b127260_c124a30), [c12bce0] "m"(b127260_c12bce0), [c81fa0] "m"(b127260_c81fa0), [c126700] "m"(b127260_c126700), [c12b650] "m"(b127260_c12b650)
      : "memory");
}
#else
#error "FUN_00127260: clang naked draft required"
#endif


/* FUN_00127310 (0x127310) — XBE naked draft (batch 147). */
#if defined(__clang__)
static int16_t (*const b127310_c124a30)(void *server, void *out_param) = network_game_client_get_state;
static bool (*const b127310_c12bce0)(int param_1, int param_2, short *param_3, short *param_4, short *param_5, int param_6) = FUN_0012bce0;
static void (*const b127310_c124e90)(void *client, void *source, int timestamp) = network_game_client_ponged;
static void (*const b127310_c12b650)(const char *fmt, ...) = network_game_log;

__attribute__((naked, noinline))
char FUN_00127310(void *client /* */ __attribute__((unused)), void *message __attribute__((unused)), int message_size __attribute__((unused)), void *source_address __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [c124a30] "m"(b127310_c124a30), [c12bce0] "m"(b127310_c12bce0), [c124e90] "m"(b127310_c124e90), [c12b650] "m"(b127310_c12b650)
      : "memory");
}
#else
#error "FUN_00127310: clang naked draft required"
#endif
...
/* FUN_00127710 (0x127710) — XBE naked draft (batch 135). */
#if defined(__clang__)
static void (*const b127710_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const b127710_exitfn)(int) = system_exit;
static char (*const b127710_c124d50)(void *client, void *source_address) = network_game_client_address_matches_server;
static int16_t (*const b127710_c124a30)(void *server, void *out_param) = network_game_client_get_state;
static bool (*const b127710_c12bce0)(int param_1, int param_2, short *param_3, short *param_4, short *param_5, int param_6) = FUN_0012bce0;
static void (*const b127710_c12b650)(const char *fmt, ...) = network_game_log;

__attribute__((naked, noinline))
char FUN_00127710(void *client /* */ __attribute__((unused)), void *source_address /* */ __attribute__((unused)), void *message __attribute__((unused)), int message_size __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(b127710_assert), [exitfn] "m"(b127710_exitfn), [c124d50] "m"(b127710_c124d50), [c124a30] "m"(b127710_c124a30), [c12bce0] "m"(b127710_c12bce0), [c12b650] "m"(b127710_c12b650)
      : "memory");
}
#else
#error "FUN_00127710: clang naked draft required"
#endif
