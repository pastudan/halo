...
{
  terminal_output(*(void **)0x2ee6d4, (const char *)0x257984, text);
}
...
char FUN_000caec0(const char *s __attribute__((unused)))
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c8df60] "m"(bcaec0_c8df60)
      : "memory");
}
#else
#error "FUN_000caec0: clang naked draft required"
#endif
...
int FUN_000ce200(void)
{
  int handle;
  char *datum;
  handle = data_new_at_index(*(data_t **)0x5aa698);
  if (handle != -1) {
    datum = (char *)datum_get(*(data_t **)0x5aa698, handle);
    *(int16_t *)(datum + 6) = 0;
    *(int *)(datum + 8) = -1;
  }
  return handle;
...
/* FUN_000cafc0 (0xcafc0) — XBE naked draft (batch 180). */
#if defined(__clang__)
static int (*const bcafc0_cce200)(void) = FUN_000ce200;
static void (*const bcafc0_cce2b0)(int list_handle, int object_handle) = FUN_000ce2b0;

__attribute__((naked, noinline))
int FUN_000cafc0(int object_handle __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [cce200] "m"(bcafc0_cce200), [cce2b0] "m"(bcafc0_cce2b0)
      : "memory");
}
#else
#error "FUN_000cafc0: clang naked draft required"
#endif
...
#if defined(__clang__)
static void *(*const bce420_dget)(void *, int) = (void *(*)(void *, int))datum_get;

__attribute__((naked, noinline))
int16_t FUN_000ce420(int list_handle __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
...
#else
#error "FUN_000ce420: clang naked draft required"
#endif
...
/* FUN_000ca4e0 (0xca4e0) — XBE naked draft (batch 167). */
#if defined(__clang__)
static void (*const bca4e0_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const bca4e0_exitfn)(int) = system_exit;
static int (*const bca4e0_c1d90f0)(char *buffer, const char *format, ...) = crt_sprintf;

__attribute__((naked, noinline))
void FUN_000ca4e0(int16_t type __attribute__((unused)), char flag __attribute__((unused)), char *buffer __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(bca4e0_assert), [exitfn] "m"(bca4e0_exitfn), [c1d90f0] "m"(bca4e0_c1d90f0)
      : "memory");
}
#else
#error "FUN_000ca4e0: clang naked draft required"
#endif


/* FUN_000ca530 (0xca530) — XBE naked draft (batch 168). */
#if defined(__clang__)
static void (*const bca530_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const bca530_exitfn)(int) = system_exit;
static int (*const bca530_c1d90f0)(char *buffer, const char *format, ...) = crt_sprintf;

__attribute__((naked, noinline))
void FUN_000ca530(int16_t type __attribute__((unused)), float value __attribute__((unused)), char *buffer __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(bca530_assert), [exitfn] "m"(bca530_exitfn), [c1d90f0] "m"(bca530_c1d90f0)
      : "memory");
}
#else
#error "FUN_000ca530: clang naked draft required"
#endif


/* FUN_000ca580 (0xca580) — XBE naked draft (batch 173). */
#if defined(__clang__)
static void (*const bca580_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const bca580_exitfn)(int) = system_exit;
static int (*const bca580_c1d90f0)(char *buffer, const char *format, ...) = crt_sprintf;

__attribute__((naked, noinline))
void FUN_000ca580(int16_t type __attribute__((unused)), int16_t value __attribute__((unused)), char *buffer __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(bca580_assert), [exitfn] "m"(bca580_exitfn), [c1d90f0] "m"(bca580_c1d90f0)
      : "memory");
}
#else
#error "FUN_000ca580: clang naked draft required"
#endif
...
static void (*const bca620_exitfn)(int) = system_exit;
static int (*const bca620_c1d90f0)(char *buffer, const char *format, ...) = crt_sprintf;

__attribute__((naked, noinline))
void FUN_000ca620(int16_t type __attribute__((unused)), int value __attribute__((unused)), char *buffer __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(bca620_assert), [exitfn] "m"(bca620_exitfn), [c1d90f0] "m"(bca620_c1d90f0)
      : "memory");
}
#else
#error "FUN_000ca620: clang naked draft required"
#endif
...
#if defined(__clang__)
static int (*const bca110_c140720)(int16_t index) = object_name_list_get_handle;
static void (*const bca110_cc99e0)(int object_handle) = FUN_000c99e0;
static void (*const bca110_cc9990)(int16_t name_index) = FUN_000c9990;

__attribute__((naked, noinline))
void FUN_000ca110(int16_t name_index __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [c140720] "m"(bca110_c140720), [cc99e0] "m"(bca110_cc99e0), [cc9990] "m"(bca110_cc9990)
      : "memory");
}
#else
#error "FUN_000ca110: clang naked draft required"
#endif
...
/* FUN_000c8b90 (0xc8b90) — XBE naked draft (batch 138). */
#if defined(__clang__)
static void *(*const bc8b90_dget)(void *, int) = (void *(*)(void *, int))datum_get;
static void (*const bc8b90_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const bc8b90_exitfn)(int) = system_exit;
static bool (*const bc8b90_cc7d80)(int datum_index, int16_t check_type) = hs_type_check;

__attribute__((naked, noinline))
char FUN_000c8b90(int16_t node_type __attribute__((unused)), int datum_index __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [dget] "m"(bc8b90_dget), [assert] "m"(bc8b90_assert), [exitfn] "m"(bc8b90_exitfn), [cc7d80] "m"(bc8b90_cc7d80)
      : "memory");
}
#else
#error "FUN_000c8b90: clang naked draft required"
#endif


/* FUN_000c8e00 (0xc8e00) — XBE naked draft (batch 136). */
#if defined(__clang__)
static void *(*const bc8e00_dget)(void *, int) = (void *(*)(void *, int))datum_get;
static void (*const bc8e00_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const bc8e00_exitfn)(int) = system_exit;
static void * (*const bc8e00_cc3d00)(int16_t function_index) = hs_function_table_get;
static char (*const bc8e00_cc55d0)(const char *name, int *out_handles, int16_t max_count, int root_handle) = FUN_000c55d0;
static bool (*const bc8e00_cc7d80)(int datum_index, int16_t check_type) = hs_type_check;

__attribute__((naked, noinline))
char FUN_000c8e00(int16_t function_index __attribute__((unused)), int root_datum __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [dget] "m"(bc8e00_dget), [assert] "m"(bc8e00_assert), [exitfn] "m"(bc8e00_exitfn), [cc3d00] "m"(bc8e00_cc3d00), [cc55d0] "m"(bc8e00_cc55d0), [cc7d80] "m"(bc8e00_cc7d80)
      : "memory");
}
#else
#error "FUN_000c8e00: clang naked draft required"
#endif
...
#if defined(__clang__)
static void *(*const bc9c80_get)(int, int) = object_get_and_verify_type;
static void *(*const bc9c80_tag)(int, int) = tag_get;
static int (*const bc9c80_c8dcb0)(const char *s1, const char *s2) = csstrcmp;
static void *(*const bc9c80_elem)(void *, int, int) = tag_block_get_element;
static int (*const bc9c80_c1dd801)(const char *a, const char *b) = crt_stricmp;
static void (*const bc9c80_c1402c0)(int object_handle, const char *marker_name, short region_index, char param_4) = object_permute_region;

__attribute__((naked, noinline))
void FUN_000c9c80(int object_handle __attribute__((unused)), int region_name __attribute__((unused)), int variant __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [get] "m"(bc9c80_get), [tag] "m"(bc9c80_tag), [c8dcb0] "m"(bc9c80_c8dcb0), [elem] "m"(bc9c80_elem), [c1dd801] "m"(bc9c80_c1dd801), [c1402c0] "m"(bc9c80_c1402c0)
      : "memory");
}
#else
#error "FUN_000c9c80: clang naked draft required"
#endif
...
static void (*const bca700_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const bca700_exitfn)(int) = system_exit;
static void (*const bca700_c119b20)(data_t *data) = data_delete_all;
static int (*const bca700_c119570)(data_t *data, int handle) = data_new_datum;
static void (*const bca700_c8f390)(unsigned __int16 a1, const char *a2, ...) = error;
...
void FUN_000ca700(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1bfe10] "m"(bca700_c1bfe10), [assert] "m"(bca700_assert), [exitfn] "m"(bca700_exitfn), [c119b20] "m"(bca700_c119b20), [c119570] "m"(bca700_c119570), [c8f390] "m"(bca700_c8f390)
      : "memory");
}
#else
#error "FUN_000ca700: clang naked draft required"
#endif
...
/* FUN_000caf80 (0xcaf80) — XBE naked draft (batch 179). */
#if defined(__clang__)
static int (*const bcaf80_c140720)(int16_t index) = object_name_list_get_handle;
static int (*const bcaf80_cce200)(void) = FUN_000ce200;
static void (*const bcaf80_cce2b0)(int list_handle, int object_handle) = FUN_000ce2b0;

__attribute__((naked, noinline))
int FUN_000caf80(int16_t name_index __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [c140720] "m"(bcaf80_c140720), [cce200] "m"(bcaf80_cce200), [cce2b0] "m"(bcaf80_cce2b0)
      : "memory");
}
#else
#error "FUN_000caf80: clang naked draft required"
#endif
...
/* FUN_000c88b0 (0xc88b0) — XBE naked draft (batch 129). */
#if defined(__clang__)
static void (*const bc88b0_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const bc88b0_exitfn)(int) = system_exit;
static void * (*const bc88b0_cc3d00)(int16_t function_index) = hs_function_table_get;
static char (*const bc88b0_cc55d0)(const char *name, int *out_handles, int16_t max_count, int root_handle) = FUN_000c55d0;
static bool (*const bc88b0_cc7d80)(int datum_index, int16_t check_type) = hs_type_check;
static void *(*const bc88b0_dget)(void *, int) = (void *(*)(void *, int))datum_get;

__attribute__((naked, noinline))
char FUN_000c88b0(int16_t function_index __attribute__((unused)), int root_datum __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(bc88b0_assert), [exitfn] "m"(bc88b0_exitfn), [cc3d00] "m"(bc88b0_cc3d00), [cc55d0] "m"(bc88b0_cc55d0), [cc7d80] "m"(bc88b0_cc7d80), [dget] "m"(bc88b0_dget)
      : "memory");
}
#else
#error "FUN_000c88b0: clang naked draft required"
#endif
...
/* FUN_000c8c50 (0xc8c50) — XBE naked draft (batch 134). */
#if defined(__clang__)
static void (*const bc8c50_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const bc8c50_exitfn)(int) = system_exit;
static void *(*const bc8c50_dget)(void *, int) = (void *(*)(void *, int))datum_get;
static bool (*const bc8c50_cc7d80)(int datum_index, int16_t check_type) = hs_type_check;

__attribute__((naked, noinline))
char FUN_000c8c50(int16_t function_index __attribute__((unused)), int root_datum __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(bc8c50_assert), [exitfn] "m"(bc8c50_exitfn), [dget] "m"(bc8c50_dget), [cc7d80] "m"(bc8c50_cc7d80)
      : "memory");
}
#else
#error "FUN_000c8c50: clang naked draft required"
#endif


/* FUN_000c8d30 (0xc8d30) — XBE naked draft (batch 136). */
#if defined(__clang__)
static void (*const bc8d30_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const bc8d30_exitfn)(int) = system_exit;
static void * (*const bc8d30_cc3d00)(int16_t function_index) = hs_function_table_get;
static char (*const bc8d30_cc55d0)(const char *name, int *out_handles, int16_t max_count, int root_handle) = FUN_000c55d0;
static void *(*const bc8d30_dget)(void *, int) = (void *(*)(void *, int))datum_get;
static bool (*const bc8d30_cc7d80)(int datum_index, int16_t check_type) = hs_type_check;
static scenario_t * (*const bc8d30_c18e380)(void) = global_scenario_get;
static void *(*const bc8d30_elem)(void *, int, int) = tag_block_get_element;

__attribute__((naked, noinline))
char FUN_000c8d30(int16_t function_index __attribute__((unused)), int root_datum __attribute__((unused)))
{
  __asm__ volatile(
      "pushl %%ebp\n\t"
      "movl %%esp, %%ebp\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(bc8d30_assert), [exitfn] "m"(bc8d30_exitfn), [cc3d00] "m"(bc8d30_cc3d00), [cc55d0] "m"(bc8d30_cc55d0), [dget] "m"(bc8d30_dget), [cc7d80] "m"(bc8d30_cc7d80), [c18e380] "m"(bc8d30_c18e380), [elem] "m"(bc8d30_elem)
      : "memory");
}
#else
#error "FUN_000c8d30: clang naked draft required"
#endif
...
/* FUN_000ce4a0 (0xce4a0) — XBE naked draft (batch 188). */
#if defined(__clang__)
static int __stdcall (*const bce4a0_c1cf900)(int handle) = CloseHandle;
...
void FUN_000ce4a0(void)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [c1cf900] "m"(bce4a0_c1cf900)
      : "memory");
}
#else
#error "FUN_000ce4a0: clang naked draft required"
#endif
