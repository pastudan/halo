...
/* ai_handle_damage (0x40460) — readable C lift (restored pre-naked). */
...
/* ai_disconnect_from_structure_bsp (0x40a80) — readable C lift. */
...
/* ai_handle_editing (0x41e80) — readable C lift. */
