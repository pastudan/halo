...
{
  int actor_handle = *(int *)0x5ac9f8;
  void *actor;
  int speech;
  if (actor_handle == -1)
    return;
  actor = datum_get(*(void **)0x6325a4, actor_handle);
  speech = FUN_001a67e0(a0);
  if (*(int *)((char *)actor + 0x18) == -1)
    return;
  if ((unsigned short)speech == 0xffff)
    return;
  *(unsigned char *)0x5aca89 = 1;
  *(unsigned char *)0x6324e0 = 1;
  *(unsigned short *)0x6324e8 = 0;
  *(unsigned char *)0x6324e1 = 0;
  *(int *)0x6324e4 = *(int *)((char *)actor + 0x18);
  *(unsigned short *)0x6324ea = (unsigned short)speech;
}
...
static void * (*const b4c920_c18e3c0)(void) = scenario_get;
