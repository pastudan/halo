...
/* FUN_000bb670 (0xbb670) — readable C lift (restored pre-naked). */
...
/* players_debug_render (0xbc520) — readable C lift (restored pre-naked). */
...
/* players_reconnect_to_structure_bsp (0xbca60) — readable C lift (restored pre-naked). */
