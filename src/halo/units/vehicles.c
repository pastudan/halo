...
/* FUN_001b6250 (0x1b6250) — readable C lift (restored pre-naked). */
void FUN_001b6250(int vehicle_handle, void *physics_buffer, void *wheel_state)
{
  int eax = 0;
...
/* FUN_001b69a0 (0x1b69a0) — readable C lift (restored pre-naked). */
...
/* FUN_001b8570 (0x1b8570) — readable C lift (restored pre-naked). */
void FUN_001b8570(int object_handle, float dt, void *contact_buf, void *wheel_buf)
{
  char *veh;
  char *vehi;
  char *phys;
