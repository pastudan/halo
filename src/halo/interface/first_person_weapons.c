...
#if defined(__clang__)
static void (*const fpwu_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const fpwu_exitfn)(int) = system_exit;
static void (*const fpwu_xerror)(unsigned short, const char *, ...) = error;
static void (*const fpwu_v2ang)(float *, float *) = vector_to_angles;
static void (*const fpwu_anmats)(void) = animation_graph_node_matrices_from_orientations;
static void (*const fpwu_interp)(void) = interpolate_node_orientations;
static void (*const fpwu_a21d60)(void *, void *, int, void *) = FUN_00121d60;
static void (*const fpwu_ovlay)(void *, int, void *) = overlay_animation_apply;
static void (*const fpwu_ovlays)(void *, int, float, void *) = overlay_animation_apply_scaled;
static void (*const fpwu_a22a50)(int, float, float, int) = FUN_00122a50;
static void (*const fpwu_a23aa0)(void *, void *) = FUN_00123aa0;
static void *(*const fpwu_tryget)(int, int) = object_try_and_get_and_verify_type;
static void *(*const fpwu_get)(int, int) = object_get_and_verify_type;
static void *(*const fpwu_elem)(void *, int, int) = tag_block_get_element;
static void *(*const fpwu_tag)(int, int) = tag_get;
...
void first_person_weapon_update(int16_t local_player_index@<ax>)
{
  __asm__ volatile(
      ...
      "testw %%si, %%si\n\t"
      "pushl %%edi\n\t"
      "jl .Lfirst_person_weapon_update_1\n\t"
      "cmpw $4, %%si\n\t"
      "jl .Lfirst_person_weapon_update_2\n\t"
      ".Lfirst_person_weapon_update_1:\n\t"
      "pushl $1\n\t"
      "pushl $0x599\n\t"
      "pushl $0x282294\n\t"
      "pushl $0x266fc0\n\t"
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lfirst_person_weapon_update_2:\n\t"
      "movl 0x46bea8, %%ecx\n\t"
      "movswl %%si, %%esi\n\t"
      "movl %%esi, -0x14(%%ebp)\n\t"
      "imull $0x1ea0, %%esi, %%esi\n\t"
      "movb 0x50(%%esi,%%ecx,1), %%al\n\t"
      "addl %%ecx, %%esi\n\t"
      "testb %%al, %%al\n\t"
      "jne .Lfirst_person_weapon_update_3\n\t"
      "leal 0x60(%%esi), %%eax\n\t"
      "pushl $0x50655c\n\t"
      "pushl %%eax\n\t"
      "call *%[v2ang]\n\t"
      ...
      "cmpl $-1, %%eax\n\t"
      "movb $1, 0x50(%%esi)\n\t"
      "je .Lfirst_person_weapon_update_4\n\t"
      "pushl $4\n\t"
      "pushl %%eax\n\t"
      "call *%[tryget]\n\t"
      "addl $8, %%esp\n\t"
      "testl %%eax, %%eax\n\t"
      "jne .Lfirst_person_weapon_update_4\n\t"
      "movl 0x8(%%esi), %%edx\n\t"
      "movl -0x14(%%ebp), %%eax\n\t"
      "pushl %%edx\n\t"
      "pushl %%eax\n\t"
      ...
      ".Lfirst_person_weapon_update_4:\n\t"
      "movl 0x8(%%esi), %%eax\n\t"
      "cmpl $-1, %%eax\n\t"
      "je .Lfirst_person_weapon_update_32\n\t"
      "pushl $4\n\t"
      "pushl %%eax\n\t"
      "call *%[get]\n\t"
      "movl (%%eax), %%ecx\n\t"
      ...
      "testl %%ecx, %%ecx\n\t"
      "movl %%ebx, -0x10(%%ebp)\n\t"
      "je .Lfirst_person_weapon_update_31\n\t"
      "pushl $0x1c\n\t"
      "pushl $0\n\t"
      "pushl %%eax\n\t"
      "call *%[elem]\n\t"
      ...
      "movw 0x16(%%esi), %%ax\n\t"
      "cmpw $0xffff, %%ax\n\t"
      "je .Lfirst_person_weapon_update_5\n\t"
      "movswl %%ax, %%ecx\n\t"
      "pushl $0xb4\n\t"
      "pushl %%ecx\n\t"
      "leal 0x74(%%ebx), %%edx\n\t"
      ...
      "pushl $0\n\t"
      "call *%[a21d60]\n\t"
      "jmp .Lfirst_person_weapon_update_6\n\t"
      ".Lfirst_person_weapon_update_5:\n\t"
      "pushl $1\n\t"
      "pushl $0x50e\n\t"
      "pushl $0x282294\n\t"
      "pushl $0\n\t"
      ...
      "pushl %%edx\n\t"
      "call *%[a23aa0]\n\t"
      ".Lfirst_person_weapon_update_6:\n\t"
      "movl -0x14(%%ebp), %%eax\n\t"
      "movl 0x10(%%eax), %%ecx\n\t"
      "addl $0x1c, %%esp\n\t"
      "cmpl $0x11, %%ecx\n\t"
      "jle .Lfirst_person_weapon_update_13\n\t"
      "movl 0x14(%%eax), %%eax\n\t"
      "movw 0x22(%%eax), %%ax\n\t"
      "cmpw $0xffff, %%ax\n\t"
      "je .Lfirst_person_weapon_update_13\n\t"
      "movswl %%ax, %%ecx\n\t"
      "pushl $0xb4\n\t"
      "pushl %%ecx\n\t"
      "leal 0x74(%%ebx), %%edx\n\t"
      ...
      "cmpw $2, 0x4e2(%%ecx)\n\t"
      "movl %%eax, -0x1c(%%ebp)\n\t"
      "jne .Lfirst_person_weapon_update_11\n\t"
      "movl 0x46bea8, %%edx\n\t"
      "movw 0xc(%%edx), %%cx\n\t"
      "cmpw $0xd, %%cx\n\t"
      "je .Lfirst_person_weapon_update_7\n\t"
      "cmpw $0xe, %%cx\n\t"
      "jne .Lfirst_person_weapon_update_11\n\t"
      ".Lfirst_person_weapon_update_7:\n\t"
      "movl -0x4(%%ebp), %%eax\n\t"
      "movw 0x25c(%%eax), %%bx\n\t"
      "movw 0x260(%%eax), %%cx\n\t"
      "movl %%eax, %%edx\n\t"
      ...
      "movw %%cx, -0xc(%%ebp)\n\t"
      "cmpw $0x2c, %%bx\n\t"
      "jl .Lfirst_person_weapon_update_10\n\t"
      "movl -0x8(%%ebp), %%eax\n\t"
      "pushl $0x70\n\t"
      "addl $0x4f0, %%eax\n\t"
      "pushl $0\n\t"
      ...
      "fnstsw %%ax\n\t"
      "testb $0x41, %%ah\n\t"
      "jne .Lfirst_person_weapon_update_8\n\t"
      "fstp %%st(0)\n\t"
      "flds 0x2533c8\n\t"
      ".Lfirst_person_weapon_update_8:\n\t"
      "movl -0x4(%%ebp), %%eax\n\t"
      "movswl 0xa(%%ecx), %%ecx\n\t"
      "movw 0x25e(%%eax), %%ax\n\t"
      "cmpw %%cx, %%ax\n\t"
      "jle .Lfirst_person_weapon_update_9\n\t"
      "movl %%ecx, %%eax\n\t"
      ".Lfirst_person_weapon_update_9:\n\t"
      "movl -0xc(%%ebp), %%ebx\n\t"
      "movswl %%ax, %%ecx\n\t"
      "movswl %%bx, %%edx\n\t"
      "subl %%edx, %%ecx\n\t"
      ...
      "addl %%eax, %%ebx\n\t"
      "movl %%ebx, -0xc(%%ebp)\n\t"
      ".Lfirst_person_weapon_update_10:\n\t"
      "movl -0xc(%%ebp), %%eax\n\t"
      "movl -0x1c(%%ebp), %%ecx\n\t"
      "pushl %%edi\n\t"
      "pushl %%eax\n\t"
      ...
      "call *%[ovlay]\n\t"
      "movl -0x10(%%ebp), %%ebx\n\t"
      "jmp .Lfirst_person_weapon_update_12\n\t"
      ".Lfirst_person_weapon_update_11:\n\t"
      "movl -0x4(%%ebp), %%edx\n\t"
      "xorl %%ecx, %%ecx\n\t"
      "movw 0x260(%%edx), %%cx\n\t"
      "cmpw 0x22(%%eax), %%cx\n\t"
      "jge .Lfirst_person_weapon_update_13\n\t"
      "pushl %%edi\n\t"
      "pushl %%ecx\n\t"
      "pushl %%eax\n\t"
      "call *%[ovlay]\n\t"
      ".Lfirst_person_weapon_update_12:\n\t"
      "addl $0xc, %%esp\n\t"
      ".Lfirst_person_weapon_update_13:\n\t"
      "movw 0x1a(%%esi), %%ax\n\t"
      "cmpw $0xffff, %%ax\n\t"
      "je .Lfirst_person_weapon_update_14\n\t"
      "movswl %%ax, %%eax\n\t"
      "pushl $0xb4\n\t"
      "pushl %%eax\n\t"
      "leal 0x74(%%ebx), %%ecx\n\t"
      ...
      "call *%[ovlay]\n\t"
      "addl $0x18, %%esp\n\t"
      ".Lfirst_person_weapon_update_14:\n\t"
      "movw 0x20(%%esi), %%ax\n\t"
      "cmpw $0xffff, %%ax\n\t"
      "je .Lfirst_person_weapon_update_15\n\t"
      "movswl %%ax, %%eax\n\t"
      "pushl $0xb4\n\t"
      "pushl %%eax\n\t"
      "leal 0x74(%%ebx), %%ecx\n\t"
      ...
      "call *%[a22a50]\n\t"
      "addl $0x10, %%esp\n\t"
      ".Lfirst_person_weapon_update_15:\n\t"
      "movl -0x14(%%ebp), %%eax\n\t"
      "cmpl $4, 0x10(%%eax)\n\t"
      "jle .Lfirst_person_weapon_update_29\n\t"
      "movl 0x14(%%eax), %%edx\n\t"
      "movw 0x8(%%edx), %%ax\n\t"
      "cmpw $0xffff, %%ax\n\t"
      "je .Lfirst_person_weapon_update_29\n\t"
      "movswl %%ax, %%eax\n\t"
      "pushl $0xb4\n\t"
      "pushl %%eax\n\t"
      "addl $0x74, %%ebx\n\t"
      ...
      "addl $0xc, %%esp\n\t"
      "cmpw $9, 0x22(%%ebx)\n\t"
      "jl .Lfirst_person_weapon_update_28\n\t"
      "flds 0x30(%%esi)\n\t"
      "fcomps 0x2533c0\n\t"
      "fnstsw %%ax\n\t"
      "testb $0x41, %%ah\n\t"
      "jne .Lfirst_person_weapon_update_16\n\t"
      "movl 0x30(%%esi), %%ecx\n\t"
      "pushl %%edi\n\t"
      "pushl %%ecx\n\t"
      "pushl $0\n\t"
      "jmp .Lfirst_person_weapon_update_17\n\t"
      ".Lfirst_person_weapon_update_16:\n\t"
      "flds 0x30(%%esi)\n\t"
      "fcomps 0x2533c0\n\t"
      "fnstsw %%ax\n\t"
      "testb $5, %%ah\n\t"
      "jp .Lfirst_person_weapon_update_18\n\t"
      "flds 0x30(%%esi)\n\t"
      "pushl %%edi\n\t"
      "pushl %%ecx\n\t"
      "fchs\n\t"
      "fstps (%%esp)\n\t"
      "pushl $1\n\t"
      ".Lfirst_person_weapon_update_17:\n\t"
      "pushl %%ebx\n\t"
      "call *%[ovlays]\n\t"
      "addl $0x10, %%esp\n\t"
      ".Lfirst_person_weapon_update_18:\n\t"
      "flds 0x34(%%esi)\n\t"
      "fcomps 0x2533c0\n\t"
      "fnstsw %%ax\n\t"
      "testb $0x41, %%ah\n\t"
      "jne .Lfirst_person_weapon_update_19\n\t"
      "movl 0x34(%%esi), %%edx\n\t"
      "pushl %%edi\n\t"
      "pushl %%edx\n\t"
      "pushl $3\n\t"
      "jmp .Lfirst_person_weapon_update_20\n\t"
      ".Lfirst_person_weapon_update_19:\n\t"
      "flds 0x34(%%esi)\n\t"
      "fcomps 0x2533c0\n\t"
      "fnstsw %%ax\n\t"
      "testb $5, %%ah\n\t"
      "jp .Lfirst_person_weapon_update_21\n\t"
      "flds 0x34(%%esi)\n\t"
      "pushl %%edi\n\t"
      "pushl %%ecx\n\t"
      "fchs\n\t"
      "fstps (%%esp)\n\t"
      "pushl $2\n\t"
      ".Lfirst_person_weapon_update_20:\n\t"
      "pushl %%ebx\n\t"
      "call *%[ovlays]\n\t"
      "addl $0x10, %%esp\n\t"
      ".Lfirst_person_weapon_update_21:\n\t"
      "flds 0x40(%%esi)\n\t"
      "fcomps 0x2533c0\n\t"
      "fnstsw %%ax\n\t"
      "testb $0x41, %%ah\n\t"
      "jne .Lfirst_person_weapon_update_22\n\t"
      "movl 0x40(%%esi), %%eax\n\t"
      "pushl %%edi\n\t"
      "pushl %%eax\n\t"
      "pushl $4\n\t"
      "jmp .Lfirst_person_weapon_update_23\n\t"
      ".Lfirst_person_weapon_update_22:\n\t"
      "flds 0x40(%%esi)\n\t"
      "fcomps 0x2533c0\n\t"
      "fnstsw %%ax\n\t"
      "testb $5, %%ah\n\t"
      "jp .Lfirst_person_weapon_update_24\n\t"
      "flds 0x40(%%esi)\n\t"
      "pushl %%edi\n\t"
      "pushl %%ecx\n\t"
      "fchs\n\t"
      "fstps (%%esp)\n\t"
      "pushl $5\n\t"
      ".Lfirst_person_weapon_update_23:\n\t"
      "pushl %%ebx\n\t"
      "call *%[ovlays]\n\t"
      "addl $0x10, %%esp\n\t"
      ".Lfirst_person_weapon_update_24:\n\t"
      "flds 0x44(%%esi)\n\t"
      "fcomps 0x2533c0\n\t"
      "fnstsw %%ax\n\t"
      "testb $0x41, %%ah\n\t"
      "jne .Lfirst_person_weapon_update_25\n\t"
      "movl 0x44(%%esi), %%ecx\n\t"
      "pushl %%edi\n\t"
      "pushl %%ecx\n\t"
      "pushl $7\n\t"
      "jmp .Lfirst_person_weapon_update_26\n\t"
      ".Lfirst_person_weapon_update_25:\n\t"
      "flds 0x44(%%esi)\n\t"
      "fcomps 0x2533c0\n\t"
      "fnstsw %%ax\n\t"
      "testb $5, %%ah\n\t"
      "jp .Lfirst_person_weapon_update_27\n\t"
      "flds 0x44(%%esi)\n\t"
      "pushl %%edi\n\t"
      "pushl %%ecx\n\t"
      "fchs\n\t"
      "fstps (%%esp)\n\t"
      "pushl $6\n\t"
      ".Lfirst_person_weapon_update_26:\n\t"
      "pushl %%ebx\n\t"
      "call *%[ovlays]\n\t"
      "addl $0x10, %%esp\n\t"
      ".Lfirst_person_weapon_update_27:\n\t"
      "flds 0x28(%%esi)\n\t"
      "fcomps 0x2533c0\n\t"
      "fnstsw %%ax\n\t"
      "testb $0x41, %%ah\n\t"
      "jne .Lfirst_person_weapon_update_28\n\t"
      "movl 0x28(%%esi), %%edx\n\t"
      "pushl %%edi\n\t"
      "pushl %%edx\n\t"
      "pushl $8\n\t"
      ...
      "call *%[ovlays]\n\t"
      "addl $0x10, %%esp\n\t"
      ".Lfirst_person_weapon_update_28:\n\t"
      "movl -0x10(%%ebp), %%ebx\n\t"
      ".Lfirst_person_weapon_update_29:\n\t"
      "xorl %%eax, %%eax\n\t"
      "movw 0x8a(%%esi), %%ax\n\t"
      "testw %%ax, %%ax\n\t"
      "jle .Lfirst_person_weapon_update_30\n\t"
      "pushl %%eax\n\t"
      "xorl %%eax, %%eax\n\t"
      "movw 0x88(%%esi), %%ax\n\t"
      "xorl %%edx, %%edx\n\t"
      ...
      "call *%[interp]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lfirst_person_weapon_update_30:\n\t"
      "movl -0x8(%%ebp), %%edi\n\t"
      ".Lfirst_person_weapon_update_31:\n\t"
      "movl 0x478(%%edi), %%ecx\n\t"
      "pushl $0x506568\n\t"
      "pushl $0x50655c\n\t"
      "pushl $0x506550\n\t"
      ...
      "call *%[anmats]\n\t"
      "addl $0x18, %%esp\n\t"
      ".Lfirst_person_weapon_update_32:\n\t"
      "popl %%edi\n\t"
      "popl %%esi\n\t"
      "popl %%ebx\n\t"
      "movl %%ebp, %%esp\n\t"
      ...
      "ret\n\t"
      :
      : [assert] "m"(fpwu_assert), [exitfn] "m"(fpwu_exitfn), [xerror] "m"(fpwu_xerror), [v2ang] "m"(fpwu_v2ang), [anmats] "m"(fpwu_anmats), [interp] "m"(fpwu_interp), [a21d60] "m"(fpwu_a21d60), [ovlay] "m"(fpwu_ovlay), [ovlays] "m"(fpwu_ovlays), [a22a50] "m"(fpwu_a22a50), [a23aa0] "m"(fpwu_a23aa0), [tryget] "m"(fpwu_tryget), [get] "m"(fpwu_get), [elem] "m"(fpwu_elem), [tag] "m"(fpwu_tag), [ftol] "m"(fpwu_ftol)
      : "memory");
}
#else
...
/* first_person_weapon_get_marker_by_name_render (0xddb90) — XBE naked draft (batch 238). */
#if defined(__clang__)
static int16_t (*const bddb90_cdcd60)(int object_handle) = FUN_000dcd60;
...
int16_t first_person_weapon_get_marker_by_name_render(int object_handle, const char *marker_name, void *out_markers, int16_t max_markers)
{
  __asm__ volatile(
      ...
      "call *%[cdcd60]\n\t"
      "cmpw %%ax, 0x506548\n\t"
      "jne .Lfirst_person_weapon_get_marker_by_name_render_1\n\t"
      "movl 0x14(%%ebp), %%eax\n\t"
      "movl 0x10(%%ebp), %%ecx\n\t"
      "movl 0xc(%%ebp), %%edx\n\t"
      "pushl %%eax\n\t"
      ...
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lfirst_person_weapon_get_marker_by_name_render_1:\n\t"
      "xorw %%ax, %%ax\n\t"
      "popl %%edi\n\t"
      "popl %%ebp\n\t"
      "ret\n\t"
      :
      : [cdcd60] "m"(bddb90_cdcd60), [cdd190] "m"(bddb90_cdd190)
      : "memory");
}
#else
#error "first_person_weapon_get_marker_by_name_render: clang naked draft required"
#endif
...
#if defined(__clang__)
static float (*const de560_r849f0)(float, float) = FUN_000849f0;
static short (*const de560_dpersp)(short) = director_get_perspective;
static void (*const de560_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const de560_exitfn)(int) = system_exit;
static void (*const de560_xerror)(unsigned short, const char *, ...) = error;
static float (*const de560_rlrand)(void) = real_local_random;
static float (*const de560_pauto)(short) = player_control_get_autoaim_level;
static short (*const de560_pzoom)(short) = player_control_get_zoom_level;
static float (*const de560_b6dd0)(float, float) = FUN_000b6dd0;
static void (*const de560_dd4d0)(short, short) = FUN_000dd4d0;
static void (*const de560_ddbd0)(int, int, int) = FUN_000ddbd0;
static void (*const de560_de3f0)(int) = FUN_000de3f0;
static char (*const de560_accel)(float *, float *, float, float, float, float, float, char) = accelerate_to_position;
static int (*const de560_anupd)(int, int, short *, int *) = animation_update_internal;
static void *(*const de560_tryget)(int, int) = object_try_and_get_and_verify_type;
static void *(*const de560_get)(int, int) = object_get_and_verify_type;
static void *(*const de560_gg)(void) = game_globals_get;
static void *(*const de560_elem)(void *, int, int) = tag_block_get_element;
static char (*const de560_ufly)(int) = unit_flying_through_air;
static void *(*const de560_tag)(int, int) = tag_get;
static int (*const de560_osnd)(int, int, short, float *, float *, float) = object_impulse_sound_new;
static void (*const de560_ftol)(void) = FUN_001d9068;
...
void FUN_000de560(int local_player_index)
{
  __asm__ volatile(
      ...
      "addl $0x10, %%esp\n\t"
      "testb %%bl, %%bl\n\t"
      "jne .LFUN_000de560_18\n\t"
      "cmpw $0, 0xc(%%esi)\n\t"
      "jne .LFUN_000de560_12\n\t"
      "movl 0x8(%%ebp), %%eax\n\t"
      "movl $6, %%edi\n\t"
      "call *%[dd4d0]\n\t"
      ".LFUN_000de560_12:\n\t"
      "movw $0xffff, 0x1a(%%esi)\n\t"
      "jmp .LFUN_000de560_18\n\t"
      ".LFUN_000de560_13:\n\t"
      "testb %%bl, %%bl\n\t"
      "je .LFUN_000de560_18\n\t"
      "movl -0x4(%%ebp), %%eax\n\t"
      ...
      "addl $0x48, %%eax\n\t"
      "testl %%ecx, %%ecx\n\t"
      "jne .LFUN_000de560_14\n\t"
      "xorl %%eax, %%eax\n\t"
      "jmp .LFUN_000de560_15\n\t"
      ".LFUN_000de560_14:\n\t"
      "pushl $0x1c\n\t"
      "pushl $0\n\t"
      "pushl %%eax\n\t"
      ...
      "movw $0, 0x1c(%%esi)\n\t"
      "cmpl $3, 0x10(%%eax)\n\t"
      "jle .LFUN_000de560_16\n\t"
      "movl 0x14(%%eax), %%edx\n\t"
      "movswl 0x6(%%edx), %%eax\n\t"
      "jmp .LFUN_000de560_17\n\t"
      ".LFUN_000de560_16:\n\t"
      "orl $0xffffffff, %%eax\n\t"
      ".LFUN_000de560_17:\n\t"
      "movw %%ax, 0x1a(%%esi)\n\t"
      ...
      "movw 0x20(%%esi), %%ax\n\t"
      "cmpw $0xffff, %%ax\n\t"
      "jne .LFUN_000de560_22\n\t"
      "cmpw $4, 0xc(%%esi)\n\t"
      "jne .LFUN_000de560_24\n\t"
      "movl -0x4(%%ebp), %%eax\n\t"
      "movl 0x48(%%eax), %%ecx\n\t"
      "addl $0x48, %%eax\n\t"
      "testl %%ecx, %%ecx\n\t"
      "jne .LFUN_000de560_19\n\t"
      "xorl %%eax, %%eax\n\t"
      "jmp .LFUN_000de560_20\n\t"
      ".LFUN_000de560_19:\n\t"
      "pushl $0x1c\n\t"
      "pushl $0\n\t"
      "pushl %%eax\n\t"
      ...
      "movl $0, 0x24(%%esi)\n\t"
      "cmpl $0xf, 0x10(%%eax)\n\t"
      "jle .LFUN_000de560_21\n\t"
      "movl 0x14(%%eax), %%eax\n\t"
      "movswl 0x1e(%%eax), %%eax\n\t"
      "movw %%ax, 0x20(%%esi)\n\t"
      "jmp .LFUN_000de560_24\n\t"
      ".LFUN_000de560_21:\n\t"
      "orl $0xffffffff, %%eax\n\t"
      "movw %%ax, 0x20(%%esi)\n\t"
      "jmp .LFUN_000de560_24\n\t"
      ...
      "jmp .LFUN_000de560_26\n\t"
      ".LFUN_000de560_25:\n\t"
      "flds -0x14(%%ebp)\n\t"
      "fcomps 0x2533c8\n\t"
      "fnstsw %%ax\n\t"
      "testb $0x41, %%ah\n\t"
      "jne .LFUN_000de560_26\n\t"
      ...
      "jmp .LFUN_000de560_28\n\t"
      ".LFUN_000de560_27:\n\t"
      "flds -0x10(%%ebp)\n\t"
      "fcomps 0x2533c8\n\t"
      "fnstsw %%ax\n\t"
      "testb $0x41, %%ah\n\t"
      "jne .LFUN_000de560_28\n\t"
      ...
      "addl $0x20, %%esp\n\t"
      "cmpl $0x3f800000, %%eax\n\t"
      "jne .LFUN_000de560_30\n\t"
      "movl $0, (%%edi)\n\t"
      ".LFUN_000de560_30:\n\t"
      "movw 0x8a(%%esi), %%ax\n\t"
      "testw %%ax, %%ax\n\t"
      "jle .LFUN_000de560_31\n\t"
      "incw 0x88(%%esi)\n\t"
      "cmpw %%ax, 0x88(%%esi)\n\t"
      "jl .LFUN_000de560_31\n\t"
      "movw $0, 0x8a(%%esi)\n\t"
      ...
      "movw 0x10(%%esi), %%ax\n\t"
      "cmpw 0xe(%%esi), %%ax\n\t"
      "jle .LFUN_000de560_36\n\t"
      "movw $0, 0xe(%%esi)\n\t"
      "call *%[rlrand]\n\t"
      "fcomps 0xa4(%%edi)\n\t"
      "fnstsw %%ax\n\t"
      "testb $1, %%ah\n\t"
      "jne .LFUN_000de560_36\n\t"
      "movl 0x8(%%ebp), %%eax\n\t"
      "pushl $1\n\t"
      "pushl $5\n\t"
      "pushl %%eax\n\t"
      "jmp .LFUN_000de560_35\n\t"
      ".LFUN_000de560_33:\n\t"
      "movw $0, 0x10(%%esi)\n\t"
      "jmp .LFUN_000de560_36\n\t"
      ".LFUN_000de560_34:\n\t"
      "cmpw $5, 0xc(%%esi)\n\t"
      "movw $0, 0x10(%%esi)\n\t"
      "jne .LFUN_000de560_36\n\t"
      ...
      "popl %%ebx\n\t"
      :
      : [r849f0] "m"(de560_r849f0), [dpersp] "m"(de560_dpersp), [assert] "m"(de560_assert), [exitfn] "m"(de560_exitfn), [xerror] "m"(de560_xerror), [rlrand] "m"(de560_rlrand), [pauto] "m"(de560_pauto), [pzoom] "m"(de560_pzoom), [b6dd0] "m"(de560_b6dd0), [dd4d0] "m"(de560_dd4d0), [ddbd0] "m"(de560_ddbd0), [de3f0] "m"(de560_de3f0), [accel] "m"(de560_accel), [anupd] "m"(de560_anupd), [tryget] "m"(de560_tryget), [get] "m"(de560_get), [gg] "m"(de560_gg), [elem] "m"(de560_elem), [ufly] "m"(de560_ufly), [tag] "m"(de560_tag), [osnd] "m"(de560_osnd), [ftol] "m"(de560_ftol), [chkstk2] "m"(de560_chkstk2)
      : "memory");
}
#else
void FUN_000de560(int local_player_index)
