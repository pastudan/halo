...
/* FUN_000d9960 (0xd9960) — readable C lift (restored pre-naked). */
...
/* render_weapon_hud (0xd9f20) — readable C lift. */
...
/* FUN_000daee0 (0xdaee0) — readable C lift (restored pre-naked). */
...
/* render_blip (0xdb330) — readable C lift. */
...
/* FUN_000dbcb0 (0xdbcb0) — readable C lift (restored pre-naked). */
void FUN_000dbcb0(void)
{
  ...
  ((void(*)(void))FUN_000db0b0)();
  ((void(*)(void))FUN_000db1e0)();
  FUN_001d9e70(0.0f, 0.0f);
