...
void FUN_000eeeb0(void *widget)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [assert] "m"(beeeb0_assert), [exitfn] "m"(beeeb0_exitfn), [ce0ee0] "m"(beeeb0_ce0ee0), [ce15b0] "m"(beeeb0_ce15b0), [c8f390] "m"(beeeb0_c8f390), [ce1760] "m"(beeeb0_ce1760), [ce4310] "m"(beeeb0_ce4310), [ce5620] "m"(beeeb0_ce5620)
      : "memory");
}
#else
#error "FUN_000eeeb0: clang naked draft required"
#endif
...
{
  (void)widget;
  if (item == NULL || *(int16_t *)((char *)item + 2) < 0 || *(int16_t *)((char *)item + 2) >= 4) {
    display_assert((const char *)0x288368, (const char *)0x2859a4, 0xfe9, 1);
    system_exit(-1);
  }
  network_game_client_local_player_quit((short)*(unsigned short *)((char *)item + 2));
  return 1;
}
...
/* FUN_000F03D0 (0xf03d0) — XBE naked draft (batch 154). */
#if defined(__clang__)
static void *(*const bf03d0_ce0ea0)(void) = player_ui_get_edit_player_profile;
static void *(*const bf03d0_ce0ec0)(void) = player_ui_get_edit_playlist_profile;
static void * (*const bf03d0_ce4310)(void *widget) = ui_widget_get_last_child;
...
void FUN_000F03D0(void *widget)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [ce0ea0] "m"(bf03d0_ce0ea0), [ce0ec0] "m"(bf03d0_ce0ec0), [ce4310] "m"(bf03d0_ce4310), [c8f390] "m"(bf03d0_c8f390)
      : "memory");
}
#else
#error "FUN_000F03D0: clang naked draft required"
#endif
...
void FUN_000f2690(void *widget)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [cd4fb0] "m"(bf2690_cd4fb0), [c19d8c0] "m"(bf2690_c19d8c0), [assert] "m"(bf2690_assert), [exitfn] "m"(bf2690_exitfn), [ce3d20] "m"(bf2690_ce3d20), [c19dc90] "m"(bf2690_c19dc90)
      : "memory");
}
#else
#error "FUN_000f2690: clang naked draft required"
#endif
...
void FUN_000f2b00(void *widget)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [assert] "m"(bf2b00_assert), [exitfn] "m"(bf2b00_exitfn), [ce0980] "m"(bf2b00_ce0980), [c1c0ed0] "m"(bf2b00_c1c0ed0)
      : "memory");
}
#else
#error "FUN_000f2b00: clang naked draft required"
#endif
...
/* FUN_000f2e60 (0xf2e60) — XBE naked draft (batch 160). */
#if defined(__clang__)
static void (*const bf2e60_assert)(const char *, const char *, int, bool) = display_assert;
static void (*const bf2e60_exitfn)(int) = system_exit;
static int (*const bf2e60_c12a0a0)(void) = FUN_0012a0a0;
...
void FUN_000f2e60(void *widget)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [assert] "m"(bf2e60_assert), [exitfn] "m"(bf2e60_exitfn), [c12a0a0] "m"(bf2e60_c12a0a0), [c8f390] "m"(bf2e60_c8f390)
      : "memory");
}
#else
#error "FUN_000f2e60: clang naked draft required"
#endif
...
void FUN_000f2ed0(void *widget)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [assert] "m"(bf2ed0_assert), [exitfn] "m"(bf2ed0_exitfn), [c12a0a0] "m"(bf2ed0_c12a0a0), [ce3d20] "m"(bf2ed0_ce3d20), [c19e9f0] "m"(bf2ed0_c19e9f0), [c8f390] "m"(bf2ed0_c8f390)
      : "memory");
}
#else
#error "FUN_000f2ed0: clang naked draft required"
#endif
...
void color_picker_get_string(void *widget)
{
  __asm__ volatile(
      ...
      "call *%[exitfn]\n\t"
      "addl $0x14, %%esp\n\t"
      ".Lcolor_picker_get_string_1:\n\t"
      "call *%[c12a0a0]\n\t"
      "testl %%eax, %%eax\n\t"
      "je .Lcolor_picker_get_string_8\n\t"
      "movl 0xbc(%%eax), %%eax\n\t"
      "decl %%eax\n\t"
      "cmpl $4, %%eax\n\t"
      "ja .Lcolor_picker_get_string_7\n\t"
      "jmp *.Lcolor_picker_get_string_jt(,%%eax,4)\n\t"
      ".Lcolor_picker_get_string_2:\n\t"
      "movw $0, 0x50(%%esi)\n\t"
      "popl %%esi\n\t"
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lcolor_picker_get_string_3:\n\t"
      "movw $2, 0x50(%%esi)\n\t"
      "popl %%esi\n\t"
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lcolor_picker_get_string_4:\n\t"
      "movw $3, 0x50(%%esi)\n\t"
      "popl %%esi\n\t"
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lcolor_picker_get_string_5:\n\t"
      "movw $1, 0x50(%%esi)\n\t"
      "popl %%esi\n\t"
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lcolor_picker_get_string_6:\n\t"
      "movw $4, 0x50(%%esi)\n\t"
      "popl %%esi\n\t"
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lcolor_picker_get_string_7:\n\t"
      "movw $5, 0x50(%%esi)\n\t"
      "popl %%esi\n\t"
      "popl %%ebp\n\t"
      "ret\n\t"
      ".Lcolor_picker_get_string_8:\n\t"
      "pushl $0x28931c\n\t"
      "pushl $2\n\t"
      "call *%[c8f390]\n\t"
      "addl $8, %%esp\n\t"
      ...
      "ret\n\t"
      ".section .rdata,\"dr\"\n\t"
      ".Lcolor_picker_get_string_jt:\n\t"
      ".long .Lcolor_picker_get_string_2\n\t"
      ".long .Lcolor_picker_get_string_3\n\t"
      ".long .Lcolor_picker_get_string_4\n\t"
      ".long .Lcolor_picker_get_string_5\n\t"
      ".long .Lcolor_picker_get_string_6\n\t"
      ".text\n\t"
      :
      : [assert] "m"(bf31d0_assert), [exitfn] "m"(bf31d0_exitfn), [c12a0a0] "m"(bf31d0_c12a0a0), [c8f390] "m"(bf31d0_c8f390)
      : "memory");
}
#else
#error "color_picker_get_string: clang naked draft required"
#endif
...
void FUN_000f3280(void *widget)
{
  __asm__ volatile(
      ...
      "ret\n\t"
      :
      : [assert] "m"(bf3280_assert), [exitfn] "m"(bf3280_exitfn), [c12a0a0] "m"(bf3280_c12a0a0), [ce3d20] "m"(bf3280_ce3d20), [c19e9f0] "m"(bf3280_c19e9f0), [c8f390] "m"(bf3280_c8f390)
      : "memory");
}
#else
#error "FUN_000f3280: clang naked draft required"
#endif
...
void FUN_000f3320(void *widget)
{
  __asm__ volatile(
      ...
      ".section .rdata,\"dr\"\n\t"
      ".LFUN_000f3320_jt:\n\t"
      ".long .LFUN_000f3320_2\n\t"
      ".long .LFUN_000f3320_3\n\t"
      ".long .LFUN_000f3320_4\n\t"
      ".long .LFUN_000f3320_5\n\t"
      ".long .LFUN_000f3320_6\n\t"
      ".text\n\t"
      :
      : [assert] "m"(bf3320_assert), [exitfn] "m"(bf3320_exitfn), [ce0ec0] "m"(bf3320_ce0ec0), [c8f390] "m"(bf3320_c8f390)
      : "memory");
}
#else
#error "FUN_000f3320: clang naked draft required"
#endif
...
/* mp_level_select_list_update_displayed_items (0xf3540) — readable C lift. */
void mp_level_select_list_update_displayed_items(void *widget)
{
  void *ctx = FUN_0012a0a0();
  if (*(int16_t *)((char *)widget + 0xe) != 0) {
    display_assert((const char *)0x289430, (const char *)0x288938, 0xbfc, 1);
    system_exit(-1);
  }
  if (ctx != NULL) {
    unsigned char cl = *(unsigned char *)((char *)ctx + 0xc0);
    *(uint16_t *)((char *)widget + 0x50) = (uint16_t)(cl != 1);
  }
}
...
void get_editable_playlist_profile_display_name(void *widget)
{
  if (*(int16_t *)((char *)widget + 0xe) != 1) {
    display_assert((const char *)0x2894f4, (const char *)0x288938, 0xc3c, 1);
    system_exit(-1);
  }
