#!/usr/bin/env python3
"""Apply network_client_manager.obj batch drafts to kb + allowlist."""
...
from gen_network_client_manager_batch import DECLS  # noqa: E402
...
def main() -> None:
    ...
    print("kb+allowlist updated for", len(DECLS), "network_client_manager drafts")
