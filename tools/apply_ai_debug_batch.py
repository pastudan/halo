#!/usr/bin/env python3
"""Apply ai_debug.obj batch drafts to kb + allowlist."""
...
from gen_ai_debug_batch import DECLS  # noqa: E402
...
def main() -> None:
    ...
    print("kb+allowlist updated for", len(DECLS), "ai_debug drafts")
