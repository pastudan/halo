#!/usr/bin/env python3
"""Apply ui_widget.obj batch1 drafts to kb + allowlist."""
...
from gen_ui_widget_batch1 import DECLS  # noqa: E402
...
def main() -> None:
    ...
    print("kb+allowlist updated for", len(DECLS), "ui_widget batch1 drafts")
