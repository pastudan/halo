#!/usr/bin/env python3
"""Apply ui_widget.obj batch2 drafts to kb + allowlist."""
...
from gen_ui_widget_batch2 import DECLS  # noqa: E402
...
def main() -> None:
    ...
    print("kb+allowlist updated for", len(DECLS), "ui_widget batch2 drafts")
