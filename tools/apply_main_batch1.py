#!/usr/bin/env python3
"""Apply main.obj batch1 drafts to kb + allowlist."""
...
from gen_main_batch1 import DECLS  # noqa: E402

OBJECT = "main.obj"

HELPER_DECLS = {
    "0x1b9de0": "bool cache_files_give_time_to_precache(const char *name);",
    "0xe43d0": "void main_menu_active(int flag);",
}
...
def main() -> None:
    ...
    print("kb+allowlist updated for", len(DECLS), "main batch1 drafts")
