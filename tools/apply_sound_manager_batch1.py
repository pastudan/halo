#!/usr/bin/env python3
"""Apply sound_manager.obj batch1 drafts to kb + allowlist."""
...
from gen_sound_manager_batch1 import DECLS  # noqa: E402
...
def main() -> None:
    ...
    print("kb+allowlist updated for", len(DECLS), "sound_manager batch1 drafts")
