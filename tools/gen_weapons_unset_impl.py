#!/usr/bin/env python3
"""Generate draft C implementations for remaining weapons.obj unset symbols."""
from __future__ import annotations

from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
OUT = ROOT / "tools" / "weapons_unset_fragment.c"
...
DECLS = {
    "0xfad60": "int weapon_place(int weapon_handle, void *placement);",
    "0xfaf50": "char weapon_can_be_fired(int weapon_handle);",
    "0xfafe0": "char weapon_useful(int weapon_handle);",
    "0xfb010": "float weapon_compute_movement_penalty(int weapon_handle, char aiming, char param_3);",
    "0xfb320": "char *FUN_000fb320(void *weapon_obj, int16_t trigger_index);",
    "0xfb510": "float FUN_000fb510(int weapon_handle, int16_t trigger_index);",
    "0xfb5a0": "char FUN_000fb5a0(int weapon_handle, int16_t trigger_index);",
    "0xfb690": "void FUN_000fb690(int weapon_handle, int16_t magazine_index);",
    "0xfb7d0": "int FUN_000fb7d0(int effect_tag, int weapon_handle);",
    "0xfb880": "void weapon_trigger_release_charge(int16_t charge_counter, int weapon_handle, char state, int16_t trigger_index);",
    "0xfb910": "void FUN_000fb910(int weapon_handle, int16_t trigger_index, char flag);",
    "0xfb990": "void FUN_000fb990(int weapon_handle);",
    "0xfba00": "char FUN_000fba00(int16_t value, int16_t threshold);",
    "0xfbcf0": "float FUN_000fbcf0(float base, float exponent);",
    "0xfbd10": "char weapon_new(int weapon_handle);",
    "0xfbea0": "void weapon_delete(int weapon_handle);",
    "0xfbf00": "void weapon_export_function_values(int weapon_handle);",
    "0xfc4b0": "void weapon_owner_update(int weapon_handle);",
    "0xfc550": "void weapon_build_weapon_interface_state(int weapon_handle, int out_state);",
    "0xfc690": "char weapon_reloading(int weapon_handle);",
    "0xfc710": "int16_t weapon_rotate_zoom_level(int weapon_handle, int16_t zoom_level);",
    "0xfc780": "float weapon_get_zoom_magnification(int weapon_handle, int16_t zoom_level);",
    "0xfc8e0": "float weapon_get_field_of_view(int weapon_handle, float base_fov, int16_t zoom_level);",
    "0xfc930": "char weapon_prevents_melee_attack(int weapon_handle);",
    "0xfcbd0": "void FUN_000fcbd0(int16_t magazine_index, int weapon_handle);",
    "0xfcc90": "void FUN_000fcc90(int weapon_handle, int16_t magazine_index);",
    "0xfcd10": "void FUN_000fcd10(int trigger_index, int weapon_handle);",
    "0xfcdd0": "void FUN_000fcdd0(int trigger_index, int weapon_handle);",
    "0xfce60": "void FUN_000fce60(int weapon_handle, int16_t trigger_index);",
    "0xfcec0": "void FUN_000fcec0(int param_a, int weapon_handle, int16_t trigger_index);",
    "0xfd0b0": "void FUN_000fd0b0(int16_t angle_index, float *out_x, float *out_y, int16_t param_3, float scale, char flag);",
    "0xfd150": "void FUN_000fd150(int weapon_handle);",
    "0xfd510": "void weapon_stop_reload(int weapon_handle);",
    "0xfd520": "void FUN_000fd520(int param_a, int weapon_handle, int16_t trigger_index);",
    "0xfd570": "void FUN_000fd570(int weapon_handle, int16_t trigger_index);",
}
