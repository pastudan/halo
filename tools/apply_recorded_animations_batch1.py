#!/usr/bin/env python3
"""Apply recorded_animations.obj batch1 drafts to kb + allowlist."""
...
from gen_recorded_animations_batch1 import DECLS  # noqa: E402

OBJECT = "recorded_animations.obj"

HELPER_DECLS = {
    "0x93780": "void FUN_00093780(int a, int *cursor, int c);",
    "0x97080": "void FUN_00097080(int object, void *ctrl_block);",
    "0x95330": "void recorded_animation_play_internal(int unit, int anim, int flags);",
}
...
def main() -> None:
    ...
    print("kb+allowlist updated for", len(DECLS), "recorded_animations batch1 drafts")
