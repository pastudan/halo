#!/usr/bin/env python3
"""Generate ui_widget.obj batch1 draft implementations + disassembly artifact."""
...
OUT = ROOT / "tools" / "ui_widget_batch1_fragment.c"
DISASM_OUT = ROOT / "artifacts" / "ui_widget_batch1_disasm.txt"
...
DECLS = {
    "0xe3b80": "bool event_controller_index_compatible_with_widget(void *widget, void *event_data);",
    "0xe3bb0": "void set_ui_plasma_effect_color(float r, float g, float b, float a);",
    "0xe3c90": "void ui_widgets_set_fade_value(float fade);",
    "0xe3ca0": "void ui_widget_debug_show_path(char show);",
    "0xe3cb0": "int widget_instance_count_children(void *widget);",
    "0xe3cd0": "void *widget_instance_get_nth_child(void *widget, int index);",
    "0xe3d50": "void widget_free(void *block);",
    "0xe3d70": "char ui_widgets_active(void);",
    "0xe3da0": "char ui_widgets_active_for_local_player(int16_t local_player_index);",
    "0xe3e60": "float FUN_000e3e60(int a, float b);",
    "0xe4330": "int widget_instance_get_child_index_from_parent(void *widget);",
    "0xe4370": "void widget_instance_set_visibility_recursive(void *widget, char visible);",
    "0xe43d0": "void main_menu_active(char active);",
    "0xe43e0": "char main_menu_is_active(void);",
    "0xe4420": "void ui_set_next_level(int16_t level_index);",
    "0xe4500": "void display_error_deferred(int16_t error_handle, int16_t local_player_index, char a3, char a4);",
    "0xe4590": "void display_error_abort_to_dashboard_deferred(int16_t error_handle, char flag);",
    "0xe4800": "void ui_widget_link_child(void *parent, void *child@<ebx>);",
    "0xe4960": "float widget_instance_get_opacity_product(void *widget@<eax>);",
    "0xe4980": "char widget_instance_is_visible_in_parent_chain(void *widget@<eax>);",
    "0xe4a40": "char widget_instance_parent_allows_focus(void *widget@<eax>);",
    "0xe4a80": "int16_t ui_widget_find_localized_string_index(wchar_t *needle@<ebx>);",
    "0xe4c70": "void FUN_000e4c70(void *draw_state@<edi>, void *cursor@<ebx>, int string_index);",
    "0xe4ce0": "char ui_widget_match_localized_substring(wchar_t *text@<eax>);",
    "0xe4d40": "char ui_widget_player_prefers_metric_units(int16_t player_index@<ax>);",
    "0xe54e0": "void get_ui_rgb_white(float *out);",
    "0xe5530": "void get_ui_argb_white(float *out);",
    "0xe5590": "void __stdcall ui_widget_filesystem_check_thread_proc(int unused);",
    "0xe55e0": "unsigned int modulate_pixel32_by_real_alpha(unsigned int pixel, float alpha);",
    "0xe5910": "void ui_widgets_close_stack_for_player(int16_t player_index);",
    "0xe59e0": "void ui_widgets_pop_stack(int16_t player_index);",
    "0xe5a40": "void main_screen_shell_begin_fade(int fade_duration);",
    "0xe5ab0": "void ui_play_audio_feedback_sound(int16_t sound_selector);",
    "0xe76b0": "void FUN_000e76b0(void *widget, void *tag, void *a, float d, int e, int f);",
    "0xe8830": "void network_game_reset_to_pregame_ui(void);",
    "0xe9a60": "char FUN_000e9a60(void *widget);",
    "0xe9bd0": "char ui_widget_event_handler_set_difficulty(void *widget, void *event_data, bool *widget_deleted);",
    "0xe9cb0": "char display_error_abort_to_dashboard(void *widget, void *event_data, bool *widget_deleted);",
    "0xe9d40": "char FUN_000E9D40(void);",
    "0xe9fd0": "char FUN_000e9fd0(void *widget);",
    "0xea1f0": "char FUN_000ea1f0(void *widget);",
    "0xea540": "char FUN_000ea540(void *widget);",
    "0xea810": "char split_screen_game_initialize(void *widget, void *player_data);",
    "0xeab70": "char FUN_000eab70(void *widget);",
    "0xecd50": "char FUN_000ecd50(void *widget);",
    "0xece10": "char playlist_profile_change_koth_rules(void *widget);",
    "0xea010": "char FUN_000ea010(void);",
    "0xea100": "char FUN_000ea100(void *widget);",
    "0xeceb0": "char FUN_000eceb0(void *widget);",
}
...
def load_targets() -> list[tuple[str, str, int]]:
    ...
    for i, (va, f) in enumerate(addrs):
        ...
        out.append((f["addr"], name.group(1) if name else f["addr"], size))
    return out


def get_bytes(xbe: Xbe, va: int, end: int) -> bytes:
...
def main() -> None:
    ...
    print("wrote", OUT, len(DECLS), "functions; batch targets", len(targets))
